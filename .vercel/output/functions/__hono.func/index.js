var Rr=Object.defineProperty;var Dt=e=>{throw TypeError(e)};var Sr=(e,t,r)=>t in e?Rr(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var g=(e,t,r)=>Sr(e,typeof t!="symbol"?t+"":t,r),ft=(e,t,r)=>t.has(e)||Dt("Cannot "+r);var l=(e,t,r)=>(ft(e,t,"read from private field"),r?r.call(e):t.get(e)),m=(e,t,r)=>t.has(e)?Dt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,r),f=(e,t,r,s)=>(ft(e,t,"write to private field"),s?s.call(e,r):t.set(e,r),r),b=(e,t,r)=>(ft(e,t,"access private method"),r);var Ht=(e,t,r,s)=>({set _(n){f(e,t,n,r)},get _(){return l(e,t,s)}});import{db as St,sql as oe}from"@vercel/postgres";import{Http2ServerRequest as Ue,constants as kr}from"http2";import{Readable as Nt}from"stream";import Cr from"crypto";var Mt=(e,t,r)=>(s,n)=>{let a=-1;return i(0);async function i(o){if(o<=a)throw new Error("next() called multiple times");a=o;let c,d=!1,p;if(e[o]?(p=e[o][0][0],s.req.routeIndex=o):p=o===e.length&&n||void 0,p)try{c=await p(s,()=>i(o+1))}catch(h){if(h instanceof Error&&t)s.error=h,c=await t(h,s),d=!0;else throw h}else s.finalized===!1&&r&&(c=await r(s));return c&&(s.finalized===!1||d)&&(s.res=c),s}},Or=Symbol(),Ar=(e,t)=>new Response(e,{headers:{"Content-Type":t.replace(/^[^;]+/,s=>s.toLowerCase())}}).formData(),yt=e=>"headers"in e,Pr=async(e,t=Object.create(null))=>{const{all:r=!1,dot:s=!1}=t,a=(yt(e)?e.headers:e.raw.headers).get("Content-Type"),i=a==null?void 0:a.split(";")[0].trim().toLowerCase();return i==="multipart/form-data"||i==="application/x-www-form-urlencoded"?Tr(e,{all:r,dot:s}):{}};async function Tr(e,t){const r=yt(e)?e.headers:e.raw.headers,s=await e.arrayBuffer(),n=Ar(s,r.get("Content-Type")||"");yt(e)||(e.bodyCache.formData=n);const a=await n;return a?Lr(a,t):{}}function Lr(e,t){const r=Object.create(null);return e.forEach((s,n)=>{t.all||n.endsWith("[]")?_r(r,n,s):r[n]=s}),t.dot&&Object.entries(r).forEach(([s,n])=>{s.includes(".")&&($r(r,s,n),delete r[s])}),r}var _r=(e,t,r)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(r):e[t]=[e[t],r]:t.endsWith("[]")?e[t]=[r]:e[t]=r},$r=(e,t,r)=>{if(/(?:^|\.)__proto__\./.test(t))return;let s=e;const n=t.split(".");n.forEach((a,i)=>{i===n.length-1?s[a]=r:((!s[a]||typeof s[a]!="object"||Array.isArray(s[a])||s[a]instanceof File)&&(s[a]=Object.create(null)),s=s[a])})},Vt=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},jr=e=>{const{groups:t,path:r}=Dr(e),s=Vt(r);return Hr(s,t)},Dr=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(r,s)=>{const n=`@${s}`;return t.push([n,r]),n}),{groups:t,path:e}},Hr=(e,t)=>{for(let r=t.length-1;r>=0;r--){const[s]=t[r];for(let n=e.length-1;n>=0;n--)if(e[n].includes(s)){e[n]=e[n].replace(s,t[r][1]);break}}return e},Ze={},Nr=(e,t)=>{if(e==="*")return"*";const r=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(r){const s=`${e}#${t}`;return Ze[s]||(r[2]?Ze[s]=t&&t[0]!==":"&&t[0]!=="*"?[s,r[1],new RegExp(`^${r[2]}(?=/${t})`)]:[e,r[1],new RegExp(`^${r[2]}$`)]:Ze[s]=[e,r[1],!0]),Ze[s]}return null},dt=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,r=>{try{return t(r)}catch{return r}})}},Mr=e=>dt(e,decodeURI),Jt=e=>{const t=e.url,r=t.indexOf("/",t.indexOf(":")+4);let s=r;for(;s<t.length;s++){const n=t.charCodeAt(s);if(n===37){const a=t.indexOf("?",s),i=t.indexOf("#",s),o=a===-1?i===-1?void 0:i:i===-1?a:Math.min(a,i),c=t.slice(r,o);return Mr(c.includes("%25")?c.replace(/%25/g,"%2525"):c)}else if(n===63||n===35)break}return t.slice(r,s)},Ir=e=>{const t=Jt(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},ae=(e,t,...r)=>(r.length&&(t=ae(t,...r)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),Xt=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),r=[];let s="";return t.forEach(n=>{if(n!==""&&!/\:/.test(n))s+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){r.length===0&&s===""?r.push("/"):r.push(s);const a=n.replace("?","");s+="/"+a,r.push(s)}else s+="/"+n}),r.filter((n,a,i)=>i.indexOf(n)===a)},ut=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?dt(e,kt):e):e,Qt=(e,t,r)=>{let s;if(!r&&t&&!/[%+]/.test(t)){let i=e.indexOf("?",8);if(i===-1)return;for(e.startsWith(t,i+1)||(i=e.indexOf(`&${t}`,i+1));i!==-1;){const o=e.charCodeAt(i+t.length+1);if(o===61){const c=i+t.length+2,d=e.indexOf("&",c);return ut(e.slice(c,d===-1?void 0:d))}else if(o==38||isNaN(o))return"";i=e.indexOf(`&${t}`,i+1)}if(s=/[%+]/.test(e),!s)return}const n={};s??(s=/[%+]/.test(e));let a=e.indexOf("?",8);for(;a!==-1;){const i=e.indexOf("&",a+1);let o=e.indexOf("=",a);o>i&&i!==-1&&(o=-1);let c=e.slice(a+1,o===-1?i===-1?void 0:i:o);if(s&&(c=ut(c)),a=i,c==="")continue;let d;o===-1?d="":(d=e.slice(o+1,i===-1?void 0:i),s&&(d=ut(d))),r?(n[c]&&Array.isArray(n[c])||(n[c]=[]),n[c].push(d)):n[c]??(n[c]=d)}return t?n[t]:n},Ur=Qt,qr=(e,t)=>Qt(e,t,!0),kt=decodeURIComponent,It=e=>dt(e,kt),ke,$,G,Zt,er,wt,q,zt,Fr=(zt=class{constructor(e,t="/",r=[[]]){m(this,G);g(this,"raw");m(this,ke);m(this,$);g(this,"routeIndex",0);g(this,"path");g(this,"bodyCache",{});m(this,q,e=>{const{bodyCache:t,raw:r}=this,s=t[e];if(s)return s;const n=Object.keys(t)[0];return n?t[n].then(a=>(n==="json"&&(a=JSON.stringify(a)),new Response(a)[e]())):t[e]=r[e]()});this.raw=e,this.path=t,f(this,$,r),f(this,ke,{})}param(e){return e?b(this,G,Zt).call(this,e):b(this,G,er).call(this)}query(e){return Ur(this.url,e)}queries(e){return qr(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((r,s)=>{t[s]=r}),t}async parseBody(e){return Pr(this,e)}json(){return l(this,q).call(this,"text").then(e=>JSON.parse(e))}text(){return l(this,q).call(this,"text")}arrayBuffer(){return l(this,q).call(this,"arrayBuffer")}bytes(){return l(this,q).call(this,"arrayBuffer").then(e=>new Uint8Array(e))}blob(){return l(this,q).call(this,"blob")}formData(){return l(this,q).call(this,"formData")}addValidatedData(e,t){l(this,ke)[e]=t}valid(e){return l(this,ke)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[Or](){return l(this,$)}get matchedRoutes(){return l(this,$)[0].map(([[,e]])=>e)}get routePath(){return l(this,$)[0].map(([[,e]])=>e)[this.routeIndex].path}},ke=new WeakMap,$=new WeakMap,G=new WeakSet,Zt=function(e){const t=l(this,$)[0][this.routeIndex][1][e],r=b(this,G,wt).call(this,t);return r&&/\%/.test(r)?It(r):r},er=function(){const e={},t=Object.keys(l(this,$)[0][this.routeIndex][1]);for(const r of t){const s=b(this,G,wt).call(this,l(this,$)[0][this.routeIndex][1][r]);s!==void 0&&(e[r]=/\%/.test(s)?It(s):s)}return e},wt=function(e){return l(this,$)[1]?l(this,$)[1][e]:e},q=new WeakMap,zt),zr={Stringify:1},tr=async(e,t,r,s,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const a=e.callbacks;return a!=null&&a.length?(n?n[0]+=e:n=[e],Promise.all(a.map(o=>o({phase:t,buffer:n,context:s}))).then(o=>Promise.all(o.filter(Boolean).map(c=>tr(c,t,!1,s,n))).then(()=>n[0]))):Promise.resolve(e)},Br="text/plain; charset=UTF-8",gt=(e,t)=>({"Content-Type":e,...t}),Ne=(e,t)=>new Response(e,t),Be,We,F,Ce,z,A,Ge,Oe,Ae,de,Ke,Ye,X,xe,Bt,Wr=(Bt=class{constructor(e,t){m(this,X);m(this,Be);m(this,We);g(this,"env",{});m(this,F);g(this,"finalized",!1);g(this,"error");m(this,Ce);m(this,z);m(this,A);m(this,Ge);m(this,Oe);m(this,Ae);m(this,de);m(this,Ke);m(this,Ye);g(this,"render",(...e)=>(l(this,Oe)??f(this,Oe,t=>this.html(t)),l(this,Oe).call(this,...e)));g(this,"setLayout",e=>f(this,Ge,e));g(this,"getLayout",()=>l(this,Ge));g(this,"setRenderer",e=>{f(this,Oe,e)});g(this,"header",(e,t,r)=>{this.finalized&&f(this,A,Ne(l(this,A).body,l(this,A)));const s=l(this,A)?l(this,A).headers:l(this,de)??f(this,de,new Headers);t===void 0?s.delete(e):r!=null&&r.append?s.append(e,t):s.set(e,t)});g(this,"status",e=>{f(this,Ce,e)});g(this,"set",(e,t)=>{l(this,F)??f(this,F,new Map),l(this,F).set(e,t)});g(this,"get",e=>l(this,F)?l(this,F).get(e):void 0);g(this,"newResponse",(...e)=>b(this,X,xe).call(this,...e));g(this,"body",(e,t,r)=>b(this,X,xe).call(this,e,t,r));g(this,"text",(e,t,r)=>!l(this,de)&&!l(this,Ce)&&!t&&!r&&!this.finalized?new Response(e):b(this,X,xe).call(this,e,t,gt(Br,r)));g(this,"json",(e,t,r)=>b(this,X,xe).call(this,JSON.stringify(e),t,gt("application/json",r)));g(this,"html",(e,t,r)=>{const s=n=>b(this,X,xe).call(this,n,t,gt("text/html; charset=UTF-8",r));return typeof e=="object"?tr(e,zr.Stringify,!1,{}).then(s):s(e)});g(this,"redirect",(e,t)=>{const r=String(e);return this.header("Location",/[^\x00-\xFF]/.test(r)?encodeURI(r):r),this.newResponse(null,t??302)});g(this,"notFound",()=>(l(this,Ae)??f(this,Ae,()=>Ne()),l(this,Ae).call(this,this)));f(this,Be,e),t&&(f(this,z,t.executionCtx),this.env=t.env,f(this,Ae,t.notFoundHandler),f(this,Ye,t.path),f(this,Ke,t.matchResult))}get req(){return l(this,We)??f(this,We,new Fr(l(this,Be),l(this,Ye),l(this,Ke))),l(this,We)}get event(){if(l(this,z)&&"respondWith"in l(this,z))return l(this,z);throw Error("This context has no FetchEvent")}get executionCtx(){if(l(this,z))return l(this,z);throw Error("This context has no ExecutionContext")}get res(){return l(this,A)||f(this,A,Ne(null,{headers:l(this,de)??f(this,de,new Headers)}))}set res(e){if(l(this,A)&&e){e=Ne(e.body,e);for(const[t,r]of l(this,A).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const s=l(this,A).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of s)e.headers.append("set-cookie",n)}else e.headers.set(t,r)}f(this,A,e),this.finalized=!0}get var(){return l(this,F)?Object.fromEntries(l(this,F)):{}}},Be=new WeakMap,We=new WeakMap,F=new WeakMap,Ce=new WeakMap,z=new WeakMap,A=new WeakMap,Ge=new WeakMap,Oe=new WeakMap,Ae=new WeakMap,de=new WeakMap,Ke=new WeakMap,Ye=new WeakMap,X=new WeakSet,xe=function(e,t,r){const s=l(this,A)?new Headers(l(this,A).headers):l(this,de)??new Headers;if(typeof t=="object"&&"headers"in t){const a=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[i,o]of a)i.toLowerCase()==="set-cookie"?s.append(i,o):s.set(i,o)}if(r)for(const[a,i]of Object.entries(r))if(typeof i=="string")s.set(a,i);else{s.delete(a);for(const o of i)s.append(a,o)}const n=typeof t=="number"?t:(t==null?void 0:t.status)??l(this,Ce);return Ne(e,{status:n,headers:s})},Bt),R="ALL",Gr="all",Kr=["get","post","put","delete","options","patch"],rr="Can not add a route since the matcher is already built.",sr=class extends Error{},Yr="__COMPOSED_HANDLER",Vr=e=>e.text("404 Not Found",404),Ut=(e,t)=>{if("getResponse"in e){const r=e.getResponse();return t.newResponse(r.body,r)}return console.error(e),t.text("Internal Server Error",500)},j,S,nr,D,ie,et,tt,Pe,Jr=(Pe=class{constructor(t={}){m(this,S);g(this,"get");g(this,"post");g(this,"put");g(this,"delete");g(this,"options");g(this,"patch");g(this,"all");g(this,"on");g(this,"use");g(this,"router");g(this,"getPath");g(this,"_basePath","/");m(this,j,"/");g(this,"routes",[]);m(this,D,Vr);g(this,"errorHandler",Ut);g(this,"onError",t=>(this.errorHandler=t,this));g(this,"notFound",t=>(f(this,D,t),this));g(this,"fetch",(t,...r)=>b(this,S,tt).call(this,t,r[1],r[0],t.method));g(this,"request",(t,r,s,n)=>t instanceof Request?this.fetch(r?new Request(t,r):t,s,n):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${ae("/",t)}`,r),s,n)));g(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(b(this,S,tt).call(this,t.request,t,void 0,t.request.method))})});[...Kr,Gr].forEach(a=>{this[a]=(i,...o)=>(typeof i=="string"?f(this,j,i):b(this,S,ie).call(this,a,l(this,j),i),o.forEach(c=>{b(this,S,ie).call(this,a,l(this,j),c)}),this)}),this.on=(a,i,...o)=>{for(const c of[i].flat()){f(this,j,c);for(const d of[a].flat())o.map(p=>{b(this,S,ie).call(this,d.toUpperCase(),l(this,j),p)})}return this},this.use=(a,...i)=>(typeof a=="string"?f(this,j,a):(f(this,j,"*"),i.unshift(a)),i.forEach(o=>{b(this,S,ie).call(this,R,l(this,j),o)}),this);const{strict:s,...n}=t;Object.assign(this,n),this.getPath=s??!0?t.getPath??Jt:Ir}route(t,r){const s=this.basePath(t);return r.routes.map(n=>{var i;let a;r.errorHandler===Ut?a=n.handler:(a=async(o,c)=>(await Mt([],r.errorHandler)(o,()=>n.handler(o,c))).res,a[Yr]=n.handler),b(i=s,S,ie).call(i,n.method,n.path,a,n.basePath)}),this}basePath(t){const r=b(this,S,nr).call(this);return r._basePath=ae(this._basePath,t),r}mount(t,r,s){let n,a;s&&(typeof s=="function"?a=s:(a=s.optionHandler,s.replaceRequest===!1?n=c=>c:n=s.replaceRequest));const i=a?c=>{const d=a(c);return Array.isArray(d)?d:[d]}:c=>{let d;try{d=c.executionCtx}catch{}return[c.env,d]};n||(n=(()=>{const c=ae(this._basePath,t),d=c==="/"?0:c.length;return p=>{const h=new URL(p.url);return h.pathname=this.getPath(p).slice(d)||"/",new Request(h,p)}})());const o=async(c,d)=>{const p=await r(n(c.req.raw),...i(c));if(p)return p;await d()};return b(this,S,ie).call(this,R,ae(t,"*"),o),this}},j=new WeakMap,S=new WeakSet,nr=function(){const t=new Pe({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,f(t,D,l(this,D)),t.routes=this.routes,t},D=new WeakMap,ie=function(t,r,s,n){t=t.toUpperCase(),r=ae(this._basePath,r);const a={basePath:n!==void 0?ae(this._basePath,n):this._basePath,path:r,method:t,handler:s};this.router.add(t,r,[s,a]),this.routes.push(a)},et=function(t,r){if(t instanceof Error)return this.errorHandler(t,r);throw t},tt=function(t,r,s,n){if(n==="HEAD")return(async()=>new Response(null,await b(this,S,tt).call(this,t,r,s,"GET")))();const a=this.getPath(t,{env:s}),i=this.router.match(n,a),o=new Wr(t,{path:a,matchResult:i,env:s,executionCtx:r,notFoundHandler:l(this,D)});if(i[0].length===1){let d;try{d=i[0][0][0][0](o,async()=>{o.res=await l(this,D).call(this,o)})}catch(p){return b(this,S,et).call(this,p,o)}return d instanceof Promise?d.then(p=>p||(o.finalized?o.res:l(this,D).call(this,o))).catch(p=>b(this,S,et).call(this,p,o)):d??l(this,D).call(this,o)}const c=Mt(i[0],this.errorHandler,l(this,D));return(async()=>{try{const d=await c(o);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return b(this,S,et).call(this,d,o)}})()},Pe),ar=[];function Xr(e,t){const r=this.buildAllMatchers(),s=((n,a)=>{const i=r[n]||r[R],o=i[2][a];if(o)return o;const c=a.match(i[0]);if(!c)return[[],ar];const d=c.indexOf("",1);return[i[1][d],c]});return this.match=s,s(e,t)}var it="[^/]+",qe=".*",Fe="(?:|/.*)",Ee=Symbol(),Qr=new Set(".\\+*[^]$()");function Zr(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===qe||e===Fe?1:t===qe||t===Fe?-1:e===it?1:t===it?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var pe,he,H,ge,es=(ge=class{constructor(){m(this,pe);m(this,he);m(this,H,Object.create(null))}insert(t,r,s,n,a){if(t.length===0){if(l(this,pe)!==void 0)throw Ee;if(a)return;f(this,pe,r);return}const[i,...o]=t,c=i==="*"?o.length===0?["","",qe]:["","",it]:i==="/*"?["","",Fe]:i.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(c){const p=c[1];let h=c[2]||it;if(p&&c[2]&&(h===".*"||(h=h.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(h))))throw Ee;if(d=l(this,H)[h],!d){if(Object.keys(l(this,H)).some(u=>u!==qe&&u!==Fe))throw Ee;if(a)return;d=l(this,H)[h]=new ge,p!==""&&f(d,he,n.varIndex++)}!a&&p!==""&&s.push([p,l(d,he)])}else if(d=l(this,H)[i],!d){if(Object.keys(l(this,H)).some(p=>p.length>1&&p!==qe&&p!==Fe))throw Ee;if(a)return;d=l(this,H)[i]=new ge}d.insert(o,r,s,n,a)}buildRegExpStr(){const r=Object.keys(l(this,H)).sort(Zr).map(s=>{const n=l(this,H)[s];return(typeof l(n,he)=="number"?`(${s})@${l(n,he)}`:Qr.has(s)?`\\${s}`:s)+n.buildRegExpStr()});return typeof l(this,pe)=="number"&&r.unshift(`#${l(this,pe)}`),r.length===0?"":r.length===1?r[0]:"(?:"+r.join("|")+")"}},pe=new WeakMap,he=new WeakMap,H=new WeakMap,ge),lt,Ve,Wt,ts=(Wt=class{constructor(){m(this,lt,{varIndex:0});m(this,Ve,new es)}insert(e,t,r){const s=[],n=[];for(let i=0;;){let o=!1;if(e=e.replace(/\{[^}]+\}/g,c=>{const d=`@\\${i}`;return n[i]=[d,c],i++,o=!0,d}),!o)break}const a=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let i=n.length-1;i>=0;i--){const[o]=n[i];for(let c=a.length-1;c>=0;c--)if(a[c].indexOf(o)!==-1){a[c]=a[c].replace(o,n[i][1]);break}}return l(this,Ve).insert(a,t,s,l(this,lt),r),s}buildRegExp(){let e=l(this,Ve).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const r=[],s=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,a,i)=>a!==void 0?(r[++t]=Number(a),"$()"):(i!==void 0&&(s[Number(i)]=++t),"")),[new RegExp(`^${e}`),r,s]}},lt=new WeakMap,Ve=new WeakMap,Wt),rs=[/^$/,[],Object.create(null)],rt=Object.create(null);function ir(e){return rt[e]??(rt[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,r)=>r?`\\${r}`:"(?:|/.*)")}$`))}function ss(){rt=Object.create(null)}function ns(e){var d;const t=new ts,r=[];if(e.length===0)return rs;const s=e.map(p=>[!/\*|\/:/.test(p[0]),...p]).sort(([p,h],[u,w])=>p?1:u?-1:h.length-w.length),n=Object.create(null);for(let p=0,h=-1,u=s.length;p<u;p++){const[w,v,k]=s[p];w?n[v]=[k.map(([P])=>[P,Object.create(null)]),ar]:h++;let E;try{E=t.insert(v,h,w)}catch(P){throw P===Ee?new sr(v):P}w||(r[h]=k.map(([P,x])=>{const N=Object.create(null);for(x-=1;x>=0;x--){const[M,De]=E[x];N[M]=De}return[P,N]}))}const[a,i,o]=t.buildRegExp();for(let p=0,h=r.length;p<h;p++)for(let u=0,w=r[p].length;u<w;u++){const v=(d=r[p][u])==null?void 0:d[1];if(!v)continue;const k=Object.keys(v);for(let E=0,P=k.length;E<P;E++)v[k[E]]=o[v[k[E]]]}const c=[];for(const p in i)c[p]=r[i[p]];return[a,c,n]}function ye(e,t){if(e){for(const r of Object.keys(e).sort((s,n)=>n.length-s.length))if(ir(r).test(t))return[...e[r]]}}var Q,Z,ct,or,Gt,as=(Gt=class{constructor(){m(this,ct);g(this,"name","RegExpRouter");m(this,Q);m(this,Z);g(this,"match",Xr);f(this,Q,{[R]:Object.create(null)}),f(this,Z,{[R]:Object.create(null)})}add(e,t,r){var o;const s=l(this,Q),n=l(this,Z);if(!s||!n)throw new Error(rr);s[e]||[s,n].forEach(c=>{c[e]=Object.create(null),Object.keys(c[R]).forEach(d=>{c[e][d]=[...c[R][d]]})}),t==="/*"&&(t="*");const a=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const c=ir(t);e===R?Object.keys(s).forEach(d=>{var p;(p=s[d])[t]||(p[t]=ye(s[d],t)||ye(s[R],t)||[])}):(o=s[e])[t]||(o[t]=ye(s[e],t)||ye(s[R],t)||[]),Object.keys(s).forEach(d=>{(e===R||e===d)&&Object.keys(s[d]).forEach(p=>{c.test(p)&&s[d][p].push([r,a])})}),Object.keys(n).forEach(d=>{(e===R||e===d)&&Object.keys(n[d]).forEach(p=>c.test(p)&&n[d][p].push([r,a]))});return}const i=Xt(t)||[t];for(let c=0,d=i.length;c<d;c++){const p=i[c];Object.keys(n).forEach(h=>{var u;(e===R||e===h)&&((u=n[h])[p]||(u[p]=[...ye(s[h],p)||ye(s[R],p)||[]]),n[h][p].push([r,a-d+c+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(l(this,Z)).concat(Object.keys(l(this,Q))).forEach(t=>{e[t]||(e[t]=b(this,ct,or).call(this,t))}),f(this,Q,f(this,Z,void 0)),ss(),e}},Q=new WeakMap,Z=new WeakMap,ct=new WeakSet,or=function(e){const t=[];let r=e===R;return[l(this,Q),l(this,Z)].forEach(s=>{const n=s[e]?Object.keys(s[e]).map(a=>[a,s[e][a]]):[];n.length!==0?(r||(r=!0),t.push(...n)):e!==R&&t.push(...Object.keys(s[R]).map(a=>[a,s[R][a]]))}),r?ns(t):null},Gt),ee,B,Kt,is=(Kt=class{constructor(e){g(this,"name","SmartRouter");m(this,ee,[]);m(this,B,[]);f(this,ee,e.routers)}add(e,t,r){if(!l(this,B))throw new Error(rr);l(this,B).push([e,t,r])}match(e,t){if(!l(this,B))throw new Error("Fatal error");const r=l(this,ee),s=l(this,B),n=r.length;let a=0,i;for(;a<n;a++){const o=r[a];try{for(let c=0,d=s.length;c<d;c++)o.add(...s[c]);i=o.match(e,t)}catch(c){if(c instanceof sr)continue;throw c}this.match=o.match.bind(o),f(this,ee,[o]),f(this,B,void 0);break}if(a===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,i}get activeRouter(){if(l(this,B)||l(this,ee).length!==1)throw new Error("No active router has been determined yet.");return l(this,ee)[0]}},ee=new WeakMap,B=new WeakMap,Kt),Me=Object.create(null),os=e=>{for(const t in e)return!0;return!1},te,C,fe,Te,O,U,V,Le,ls=(Le=class{constructor(t,r,s){m(this,U);m(this,te);m(this,C);m(this,fe);m(this,Te,0);m(this,O,Me);if(f(this,C,s||Object.create(null)),f(this,te,[]),t&&r){const n=Object.create(null);n[t]={handler:r,possibleKeys:[],score:0},f(this,te,[n])}f(this,fe,[])}insert(t,r,s){f(this,Te,++Ht(this,Te)._);let n=this;const a=jr(r),i=[];for(let o=0,c=a.length;o<c;o++){const d=a[o],p=a[o+1],h=Nr(d,p),u=Array.isArray(h)?h[0]:d;if(u in l(n,C)){n=l(n,C)[u],h&&i.push(h[1]);continue}l(n,C)[u]=new Le,h&&(l(n,fe).push(h),i.push(h[1])),n=l(n,C)[u]}return l(n,te).push({[t]:{handler:s,possibleKeys:i.filter((o,c,d)=>d.indexOf(o)===c),score:l(this,Te)}}),n}search(t,r){var p;const s=[];f(this,O,Me);let a=[this];const i=Vt(r),o=[],c=i.length;let d=null;for(let h=0;h<c;h++){const u=i[h],w=h===c-1,v=[];for(let E=0,P=a.length;E<P;E++){const x=a[E],N=l(x,C)[u];N&&(f(N,O,l(x,O)),w?(l(N,C)["*"]&&b(this,U,V).call(this,s,l(N,C)["*"],t,l(x,O)),b(this,U,V).call(this,s,N,t,l(x,O))):v.push(N));for(let M=0,De=l(x,fe).length;M<De;M++){const ve=l(x,fe)[M],_=l(x,O)===Me?{}:{...l(x,O)};if(ve==="*"){const K=l(x,C)["*"];K&&(b(this,U,V).call(this,s,K,t,l(x,O)),f(K,O,_),v.push(K));continue}const[pt,Qe,se]=ve;if(!u&&!(se instanceof RegExp))continue;const L=l(x,C)[pt];if(se instanceof RegExp){if(d===null){d=new Array(c);let Y=r[0]==="/"?1:0;for(let ne=0;ne<c;ne++)d[ne]=Y,Y+=i[ne].length+1}const K=r.substring(d[h]),be=se.exec(K);if(be){if(_[Qe]=be[0],b(this,U,V).call(this,s,L,t,l(x,O),_),be[0].length===K.length&&l(L,C)["*"]&&b(this,U,V).call(this,s,l(L,C)["*"],t,l(x,O),_),os(l(L,C))){f(L,O,_);const Y=((p=be[0].match(/\//))==null?void 0:p.length)??0;(o[Y]||(o[Y]=[])).push(L)}continue}}(se===!0||se.test(u))&&(_[Qe]=u,w?(b(this,U,V).call(this,s,L,t,_,l(x,O)),l(L,C)["*"]&&b(this,U,V).call(this,s,l(L,C)["*"],t,_,l(x,O))):(f(L,O,_),v.push(L)))}}const k=o.shift();a=k?v.concat(k):v}return s.length>1&&s.sort((h,u)=>h.score-u.score),[s.map(({handler:h,params:u})=>[h,u])]}},te=new WeakMap,C=new WeakMap,fe=new WeakMap,Te=new WeakMap,O=new WeakMap,U=new WeakSet,V=function(t,r,s,n,a){for(let i=0,o=l(r,te).length;i<o;i++){const c=l(r,te)[i],d=c[s]||c[R],p={};if(d!==void 0&&(d.params=Object.create(null),t.push(d),n!==Me||a&&a!==Me))for(let h=0,u=d.possibleKeys.length;h<u;h++){const w=d.possibleKeys[h],v=p[d.score];d.params[w]=a!=null&&a[w]&&!v?a[w]:n[w]??(a==null?void 0:a[w]),p[d.score]=!0}}},Le),ue,Yt,cs=(Yt=class{constructor(){g(this,"name","TrieRouter");m(this,ue);f(this,ue,new ls)}add(e,t,r){const s=Xt(t);if(s){for(let n=0,a=s.length;n<a;n++)l(this,ue).insert(e,s[n],r);return}l(this,ue).insert(e,t,r)}match(e,t){return l(this,ue).search(e,t)}},ue=new WeakMap,Yt),Ct=class extends Jr{constructor(e={}){super(e),this.router=e.router??new is({routers:[new as,new cs]})}},lr=/^[\w!#$%&'*.^`|~+-]+$/,ds=/^[ !#-:<-[\]-~]*$/,qt=e=>{let t=0,r=e.length;for(;t<r;){const s=e.charCodeAt(t);if(s!==32&&s!==9)break;t++}for(;r>t;){const s=e.charCodeAt(r-1);if(s!==32&&s!==9)break;r--}return t===0&&r===e.length?e:e.slice(t,r)},ps=(e,t)=>{if(t&&e.indexOf(t)===-1)return{};const r=e.split(";"),s=Object.create(null);for(const n of r){const a=n.indexOf("=");if(a===-1)continue;const i=qt(n.substring(0,a));if(t&&t!==i||!lr.test(i)||i in s)continue;let o=qt(n.substring(a+1));if(o.startsWith('"')&&o.endsWith('"')&&(o=o.slice(1,-1)),ds.test(o)&&(s[i]=o.indexOf("%")!==-1?dt(o,kt):o,t))break}return s},hs=(e,t,r={})=>{if(!lr.test(e))throw new Error("Invalid cookie name");let s=`${e}=${t}`;if(e.startsWith("__Secure-")&&!r.secure)throw new Error("__Secure- Cookie must have Secure attributes");if(e.startsWith("__Host-")){if(!r.secure)throw new Error("__Host- Cookie must have Secure attributes");if(r.path!=="/")throw new Error('__Host- Cookie must have Path attributes with "/"');if(r.domain)throw new Error("__Host- Cookie must not have Domain attributes")}for(const n of["domain","path","sameSite","priority"])if(r[n]&&/[;\r\n]/.test(r[n]))throw new Error(`${n} must not contain ";", "\\r", or "\\n"`);if(r&&typeof r.maxAge=="number"&&r.maxAge>=0){if(r.maxAge>3456e4)throw new Error("Cookies Max-Age SHOULD NOT be greater than 400 days (34560000 seconds) in duration.");s+=`; Max-Age=${r.maxAge|0}`}if(r.domain&&r.prefix!=="host"&&(s+=`; Domain=${r.domain}`),r.path&&(s+=`; Path=${r.path}`),r.expires){if(r.expires.getTime()-Date.now()>3456e7)throw new Error("Cookies Expires SHOULD NOT be greater than 400 days (34560000 seconds) in the future.");s+=`; Expires=${r.expires.toUTCString()}`}if(r.httpOnly&&(s+="; HttpOnly"),r.secure&&(s+="; Secure"),r.sameSite&&(s+=`; SameSite=${r.sameSite.charAt(0).toUpperCase()+r.sameSite.slice(1)}`),r.priority&&(s+=`; Priority=${r.priority.charAt(0).toUpperCase()+r.priority.slice(1)}`),r.partitioned){if(!r.secure)throw new Error("Partitioned Cookie must have Secure attributes");s+="; Partitioned"}return s},mt=(e,t,r)=>(t=encodeURIComponent(t),hs(e,t,r)),cr=(e,t,r)=>{const s=e.req.raw.headers.get("Cookie");{if(!s)return;let n=t;return r==="secure"?n="__Secure-"+t:r==="host"&&(n="__Host-"+t),ps(s,n)[n]}},fs=(e,t,r)=>{let s;return(r==null?void 0:r.prefix)==="secure"?s=mt("__Secure-"+e,t,{path:"/",...r,secure:!0}):(r==null?void 0:r.prefix)==="host"?s=mt("__Host-"+e,t,{...r,path:"/",secure:!0,domain:void 0}):s=mt(e,t,{path:"/",...r}),s},dr=(e,t,r,s)=>{const n=fs(t,r,s);e.header("Set-Cookie",n,{append:!0})},us=(e,t,r)=>{const s=cr(e,t,r==null?void 0:r.prefix);return dr(e,t,"",{...r,maxAge:0}),s};typeof process<"u"&&process.env&&(process.env.POSTGRES_URL=process.env.POSTGRES_URL||process.env.DATABASE_POSTGRES_URL||process.env.DATABASE_URL);const re=new Ct;re.use("*",async(e,t)=>{const r=new URL(e.req.url).pathname;if(r==="/admin/login"||r.startsWith("/static/"))return t();const s=e.env.ADMIN_PASSWORD||process.env.ADMIN_PASSWORD||"paraKenya8#";return cr(e,"codeward_admin_session")===s?t():e.redirect("/admin/login")});re.get("/login",e=>{const t=`<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8"/>
...
</html>`;return e.html(t)});re.post("/login",async e=>{const t=await e.req.parseBody(),r=e.env.ADMIN_USERNAME||process.env.ADMIN_USERNAME||"kelvin.reallife8@gmail.com",s=e.env.ADMIN_PASSWORD||process.env.ADMIN_PASSWORD||"paraKenya8#";return t.username===r&&t.password===s?(dr(e,"codeward_admin_session",s,{path:"/admin",httpOnly:!0,secure:!0,maxAge:3600*24*7}),e.redirect("/admin")):e.redirect("/admin/login?error=1")});re.get("/logout",e=>(us(e,"codeward_admin_session",{path:"/admin"}),e.redirect("/admin/login")));const st={"software-engineer":"Software Engineer","senior-engineer":"Senior / Staff Engineer","engineering-lead":"Engineering Lead / Manager","cto-vp":"CTO / VP of Engineering","devops-platform":"DevOps / Platform Engineer","security-engineer":"Security Engineer",freelancer:"Freelance Developer","open-source":"Open Source Contributor",student:"Student / Bootcamp",founder:"Founder / Indie Hacker",other:"Other"};function I(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function we(e){if(e==null)return"";const t=String(e);return/[",\n]/.test(t)?'"'+t.replace(/"/g,'""')+'"':t}re.get("/",async e=>{var Pt,Tt,Lt,_t,$t,jt;const{env:t}=e,r=new URL(e.req.url),s=(r.searchParams.get("q")||"").trim(),n=(r.searchParams.get("role")||"").trim(),a=Math.max(1,parseInt(r.searchParams.get("page")||"1",10)||1),i=25,o=r.searchParams.get("msg")||"";let c="";o==="retrigger_success"?c='<div style="background: rgba(16, 185, 129, 0.1); border: 1px solid rgba(16, 185, 129, 0.3); color: #10b981; padding: 12px 16px; border-radius: 8px; margin-bottom: 24px; font-weight: 500; display: flex; align-items: center; gap: 8px;"><svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"></path></svg> Email successfully resent!</div>':o==="retrigger_failed"&&(c='<div style="background: rgba(239, 68, 68, 0.1); border: 1px solid rgba(239, 68, 68, 0.3); color: #ef4444; padding: 12px 16px; border-radius: 8px; margin-bottom: 24px; font-weight: 500; display: flex; align-items: center; gap: 8px;"><svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12"></path></svg> Failed to resend email. Please check the logs.</div>');let d="WHERE 1=1";const p=[];let h=1;if(s){d+=` AND (LOWER(name) LIKE $${h++} OR LOWER(email) LIKE $${h++} OR LOWER(company) LIKE $${h++})`;const y=`%${s.toLowerCase()}%`;p.push(y,y,y)}n&&(d+=` AND role = $${h++}`,p.push(n));const u=await St.connect(),w=await u.query(`SELECT COUNT(*) as cnt FROM waitlist_entries ${d}`,p),v=Number(((Pt=w.rows[0])==null?void 0:Pt.cnt)??0),k=Math.max(1,Math.ceil(v/i)),E=Math.min(a,k),P=(E-1)*i,x=[...p,i,P],M=(await u.query(`SELECT id, name, email, role, company, github, position, created_at, email_sent, linkedin_clicked
     FROM waitlist_entries ${d}
     ORDER BY created_at DESC
     LIMIT $${h++} OFFSET $${h++}`,x)).rows||[],De=await u.query("SELECT COUNT(*) as cnt FROM waitlist_entries"),ve=Number(((Tt=De.rows[0])==null?void 0:Tt.cnt)??0),_=await u.query(`SELECT 
       SUM(CASE WHEN email_sent = 1 THEN 1 ELSE 0 END) as sent,
       SUM(CASE WHEN email_sent = 0 THEN 1 ELSE 0 END) as failed
     FROM waitlist_entries`),pt=Number(((Lt=_.rows[0])==null?void 0:Lt.sent)??0),Qe=Number(((_t=_.rows[0])==null?void 0:_t.failed)??0),se=await u.query("SELECT COUNT(*) as cnt FROM waitlist_entries WHERE created_at::DATE = CURRENT_DATE"),L=Number((($t=se.rows[0])==null?void 0:$t.cnt)??0),be=(await u.query("SELECT role, COUNT(*) as cnt FROM waitlist_entries GROUP BY role ORDER BY cnt DESC")).rows,Y=await u.query("SELECT COUNT(*) as cnt FROM waitlist_entries WHERE company IS NOT NULL AND company != ''"),ne=Number(((jt=Y.rows[0])==null?void 0:jt.cnt)??0),br=Object.entries(st).map(([y,T])=>`<option value="${y}" ${n===y?"selected":""}>${I(T)}</option>`).join(""),yr=M.length?M.map(y=>{const T=new Date(y.created_at+"Z"),He=isNaN(T.getTime())?y.created_at:T.toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric"})+" · "+T.toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"});return`
        <tr>
        ...
        </tr>`}).join(""):'<tr><td colspan="7" class="empty-row">No waitlist entries match your filters.</td></tr>',wr=(be||[]).map(y=>{const T=Number(y.cnt),He=ve?Math.round(T/ve*100):0;return`
      <div class="role-bar-row">
        ...
        <div class="role-bar-count">${T}</div>
      </div>`}).join(""),ht=y=>{const T=new URLSearchParams;return s&&T.set("q",s),n&&T.set("role",n),T.set("page",String(E)),Object.entries(y).forEach(([He,Er])=>T.set(He,String(Er))),"?"+T.toString()},xr=`<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8"/>
<meta name="viewport" content="width=device-width, initial-scale=1.0"/>
...
<div class="admin-page">
  ...
  <section class="panel role-breakdown-panel">
    ...
    <div class="role-bars">
      ${wr||'<p class="muted">No data yet.</p>'}
    </div>
  </section>
  ...
  <section class="panel">
    ...
    <div class="pagination">
      <span class="page-info">Showing ${M.length?P+1:0}–${P+M.length} of ${v.toLocaleString()}</span>
...
</html>`;return e.html(xr)});re.get("/export.csv",async e=>{const{env:t}=e,r=new URL(e.req.url),s=(r.searchParams.get("q")||"").trim(),n=(r.searchParams.get("role")||"").trim();let a="WHERE 1=1";const i=[];let o=1;if(s){a+=` AND (LOWER(name) LIKE $${o++} OR LOWER(email) LIKE $${o++} OR LOWER(company) LIKE $${o++})`;const v=`%${s.toLowerCase()}%`;i.push(v,v,v)}n&&(a+=` AND role = $${o++}`,i.push(n));const p=(await(await St.connect()).query(`SELECT id, name, email, role, company, github, position, created_at
  ...
  <tr>
    <td style="padding:20px 32px 0;text-align:center;">
      ...
      <p style="font-size:14.5px;line-height:23px;color:#c9d1d9;margin:0 0 14px;text-align:left;">
        Hi ${gs(r)} — thanks for requesting early access to Codeward. I wanted to reach out myself rather than send a form reply.
      </p>
      <p style="font-size:14.5px;line-height:23px;color:#c9d1d9;margin:0 0 14px;text-align:left;">
...
</html>`,o=await fetch("https://api.resend.com/emails",{method:"POST",headers:{Authorization:`Bearer ${n}`,"Content-Type":"application/json"},body:JSON.stringify({from:"Codeward <waitlist@codeward.cloud>",to:[t],subject:"You are on the Codeward waitlist",html:i})});if(!o.ok){const c=await o.text();console.error("Resend API Error:",o.status,c)}return o.ok}catch(a){return console.error("Failed to send email",a),!1}}me.post("/api/track-linkedin",async e=>{const{env:t}=e;let r;try{r=await e.req.json()}catch{return e.json({error:"Invalid body"},400)}return r.email&&await oe`UPDATE waitlist_entries SET linkedin_clicked = 1 WHERE email = ${r.email}`,e.json({success:!0})});me.get("/",e=>e.html(ms));const ms=`<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8"/>
<meta name="viewport" content="width=device-width, initial-scale=1.0"/>
...
</html>`;var le=class extends Error{constructor(e,t){super(e,t),this.name="RequestError"}},vs=e=>e instanceof le?e:new le(e.message,{cause:e}),bs=global.Request,ze=class extends bs{constructor(t,r){var s;typeof t=="object"&&$e in t&&(t=t[$e]()),typeof((s=r==null?void 0:r.body)==null?void 0:s.getReader)<"u"&&(r.duplex??(r.duplex="half")),super(t,r)}},ys=e=>{const t=[],r=e.rawHeaders;for(let s=0;s<r.length;s+=2){const{[s]:n,[s+1]:a}=r;n.charCodeAt(0)!==58&&t.push([n,a])}return new Headers(t)},hr=Symbol("wrapBodyStream"),ws=(e,t,r,s,n)=>{const a={method:e,headers:r,signal:n.signal};if(e==="TRACE"){a.method="GET";const i=new ze(t,a);return Object.defineProperty(i,"method",{get(){return"TRACE"}}),i}if(!(e==="GET"||e==="HEAD"))if("rawBody"in s&&s.rawBody instanceof Buffer)a.body=new ReadableStream({start(i){i.enqueue(s.rawBody),i.close()}});else if(s[hr]){let i;a.body=new ReadableStream({async pull(o){try{i||(i=Nt.toWeb(s).getReader());const{done:c,value:d}=await i.read();c?o.close():o.enqueue(d)}catch(c){o.error(c)}}})}else a.body=Nt.toWeb(s);return new ze(t,a)},$e=Symbol("getRequestCache"),nt=Symbol("requestCache"),at=Symbol("incomingKey"),ot=Symbol("urlKey"),vt=Symbol("headersKey"),J=Symbol("abortControllerKey"),xs=Symbol("getAbortController"),Xe={get method(){return this[at].method||"GET"},get url(){return this[ot]},get headers(){return this[vt]||(this[vt]=ys(this[at]))},[xs](){return this[$e](),this[J]},[$e](){return this[J]||(this[J]=new AbortController),this[nt]||(this[nt]=ws(this.method,this[ot],this.headers,this[at],this[J]))}};["body","bodyUsed","cache","credentials","destination","integrity","mode","redirect","referrer","referrerPolicy","signal","keepalive"].forEach(e=>{Object.defineProperty(Xe,e,{get(){return this[$e]()[e]}})});["arrayBuffer","blob","clone","formData","json","text"].forEach(e=>{Object.defineProperty(Xe,e,{value:function(){return this[$e]()[e]()}})});Object.defineProperty(Xe,Symbol.for("nodejs.util.inspect.custom"),{value:function(e,t,r){const s={method:this.method,url:this.url,headers:this.headers,nativeRequest:this[nt]};return`Request (lightweight) ${r(s,{...t,depth:e==null?null:e-1})}`}});Object.setPrototypeOf(Xe,ze.prototype);var Es=(e,t)=>{const r=Object.create(Xe);r[at]=e;const s=e.url||"";if(s[0]!=="/"&&(s.startsWith("http://")||s.startsWith("https://"))){if(e instanceof Ue)throw new le("Absolute URL for :path is not allowed in HTTP/2");try{const o=new URL(s);r[ot]=o.href}catch(o){throw new le("Invalid absolute URL",{cause:o})}return r}const n=(e instanceof Ue?e.authority:e.headers.host)||t;if(!n)throw new le("Missing host header");let a;if(e instanceof Ue){if(a=e.scheme,!(a==="http"||a==="https"))throw new le("Unsupported scheme")}else a=e.socket&&e.socket.encrypted?"https":"http";const i=new URL(`${a}://${n}${s}`);if(i.hostname.length!==n.length&&i.hostname!==n.replace(/:\d+$/,""))throw new le("Invalid host header");return r[ot]=i.href,r},Ie=Symbol("responseCache"),Se=Symbol("getResponseCache"),ce=Symbol("cache"),Ot=global.Response,Je,W,_e,je=(_e=class{constructor(t,r){m(this,Je);m(this,W);let s;if(f(this,Je,t),r instanceof _e){const n=r[Ie];if(n){f(this,W,n),this[Se]();return}else f(this,W,l(r,W)),s=new Headers(l(r,W).headers)}else f(this,W,r);(typeof t=="string"||typeof(t==null?void 0:t.getReader)<"u"||t instanceof Blob||t instanceof Uint8Array)&&(this[ce]=[(r==null?void 0:r.status)||200,t,s||(r==null?void 0:r.headers)])}[Se](){return delete this[ce],this[Ie]||(this[Ie]=new Ot(l(this,Je),l(this,W)))}get headers(){const t=this[ce];return t?(t[2]instanceof Headers||(t[2]=new Headers(t[2]||{"content-type":"text/plain; charset=UTF-8"})),t[2]):this[Se]().headers}get status(){var t;return((t=this[ce])==null?void 0:t[0])??this[Se]().status}get ok(){const t=this.status;return t>=200&&t<300}},Je=new WeakMap,W=new WeakMap,_e);["body","bodyUsed","redirected","statusText","trailers","type","url"].forEach(e=>{Object.defineProperty(je.prototype,e,{get(){return this[Se]()[e]}})});["arrayBuffer","blob","clone","formData","json","text"].forEach(e=>{Object.defineProperty(je.prototype,e,{value:function(){return this[Se]()[e]()}})});Object.defineProperty(je.prototype,Symbol.for("nodejs.util.inspect.custom"),{value:function(e,t,r){const s={status:this.status,headers:this.headers,ok:this.ok,nativeResponse:this[Ie]};return`Response (lightweight) ${r(s,{...t,depth:e==null?null:e-1})}`}});Object.setPrototypeOf(je,Ot);Object.setPrototypeOf(je.prototype,Ot.prototype);async function Rs(e){return Promise.race([e,Promise.resolve().then(()=>Promise.resolve(void 0))])}function fr(e,t,r){const s=o=>{e.cancel(o).catch(()=>{})};return t.on("close",s),t.on("error",s),(r??e.read()).then(i,n),e.closed.finally(()=>{t.off("close",s),t.off("error",s)});function n(o){o&&t.destroy(o)}function a(){e.read().then(i,n)}function i({done:o,value:c}){try{if(o)t.end();else if(!t.write(c))t.once("drain",a);else return e.read().then(i,n)}catch(d){n(d)}}}function Ss(e,t){if(e.locked)throw new TypeError("ReadableStream is locked.");return t.destroyed?void 0:fr(e.getReader(),t)}var xt=e=>{const t={};e instanceof Headers||(e=new Headers(e??void 0));const r=[];for(const[s,n]of e)s==="set-cookie"?r.push(n):t[s]=n;return r.length>0&&(t["set-cookie"]=r),t["content-type"]??(t["content-type"]="text/plain; charset=UTF-8"),t},ks="x-hono-already-sent";typeof global.crypto>"u"&&(global.crypto=Cr);var At=Symbol("outgoingEnded"),Ft=Symbol("incomingDraining"),Cs=500,Os=64*1024*1024,bt=e=>{var o,c,d;const t=e;if(e.destroyed||t[Ft])return;if(t[Ft]=!0,e instanceof Ue){try{(c=(o=e.stream)==null?void 0:o.close)==null||c.call(o,kr.NGHTTP2_NO_ERROR)}catch{}return}let r=0;const s=()=>{clearTimeout(a),e.off("data",i),e.off("end",s),e.off("error",s)},n=()=>{s();const p=e.socket;p&&!p.destroyed&&p.destroySoon()},a=setTimeout(n,Cs);(d=a.unref)==null||d.call(a);const i=p=>{r+=p.length,r>Os&&n()};e.on("data",i),e.on("end",s),e.on("error",s),e.resume()},As=()=>new Response(null,{status:400}),ur=e=>new Response(null,{status:e instanceof Error&&(e.name==="TimeoutError"||e.constructor.name==="TimeoutError")?504:500}),Et=(e,t)=>{const r=e instanceof Error?e:new Error("unknown error",{cause:e});r.code==="ERR_STREAM_PREMATURE_CLOSE"?console.info("The user aborted a request."):(console.error(e),t.headersSent||t.writeHead(500,{"Content-Type":"text/plain"}),t.end(`Error: ${r.message}`),t.destroy(r))},gr=e=>{"flushHeaders"in e&&e.writable&&e.flushHeaders()},mr=async(e,t)=>{var i,o;let[r,s,n]=e[ce],a=!1;if(!n)n={"content-type":"text/plain; charset=UTF-8"};else if(n instanceof Headers)a=n.has("content-length"),n=xt(n);else if(Array.isArray(n)){const c=new Headers(n);a=c.has("content-length"),n=xt(c)}else for(const c in n)if(c.length===14&&c.toLowerCase()==="content-length"){a=!0;break}a||(typeof s=="string"?n["Content-Length"]=Buffer.byteLength(s):s instanceof Uint8Array?n["Content-Length"]=s.byteLength:s instanceof Blob&&(n["Content-Length"]=s.size)),t.writeHead(r,n),typeof s=="string"||s instanceof Uint8Array?t.end(s):s instanceof Blob?t.end(new Uint8Array(await s.arrayBuffer())):(gr(t),await((i=Ss(s,t))==null?void 0:i.catch(c=>Et(c,t)))),(o=t[At])==null||o.call(t)},Ps=e=>typeof e.then=="function",Ts=async(e,t,r={})=>{var n;if(Ps(e))if(r.errorHandler)try{e=await e}catch(a){const i=await r.errorHandler(a);if(!i)return;e=i}else e=await e.catch(ur);if(ce in e)return mr(e,t);const s=xt(e.headers);if(e.body){const a=e.body.getReader(),i=[];let o=!1,c;if(s["transfer-encoding"]!=="chunked"){let d=2;for(let p=0;p<d;p++){c||(c=a.read());const h=await Rs(c).catch(u=>{console.error(u),o=!0});if(!h){if(p===1){await new Promise(u=>setTimeout(u)),d=3;continue}break}if(c=void 0,h.value&&i.push(h.value),h.done){o=!0;break}}o&&!("content-length"in s)&&(s["content-length"]=i.reduce((p,h)=>p+h.length,0))}t.writeHead(e.status,s),i.forEach(d=>{t.write(d)}),o?t.end():(i.length===0&&gr(t),await fr(a,t,c))}else s[ks]||(t.writeHead(e.status,s),t.end());(n=t[At])==null||n.call(t)},Ls=(e,t={})=>{const r=t.autoCleanupIncoming??!0;return t.overrideGlobalObjects!==!1&&global.Request!==ze&&(Object.defineProperty(global,"Request",{value:ze}),Object.defineProperty(global,"Response",{value:je})),async(s,n)=>{let a,i;try{i=Es(s,t.hostname);let o=!r||s.method==="GET"||s.method==="HEAD";if(o||(s[hr]=!0,s.on("end",()=>{o=!0}),s instanceof Ue&&(n[At]=()=>{o||setTimeout(()=>{o||setTimeout(()=>{bt(s)})})}),n.on("finish",()=>{o||bt(s)})),n.on("close",()=>{i[J]&&(s.errored?i[J].abort(s.errored.toString()):n.writableFinished||i[J].abort("Client connection prematurely closed.")),o||setTimeout(()=>{o||setTimeout(()=>{bt(s)})})}),a=e(i,{incoming:s,outgoing:n}),ce in a)return mr(a,n)}catch(o){if(a)return Et(o,n);if(t.errorHandler){if(a=await t.errorHandler(i?o:vs(o)),!a)return}else i?a=ur(o):a=As()}try{return await Ts(a,n,t)}catch(o){return Et(o,n)}}},_s=e=>Ls(e.fetch);const Rt=new Ct,$s=Object.assign({"/src/index.tsx":me});let vr=!1;for(const[,e]of Object.entries($s))e&&(Rt.all("*",t=>{let r;try{r=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,r)}),Rt.notFound(t=>{let r;try{r=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,r)}),vr=!0);if(!vr)throw new Error("Can't import modules from ['/src/index.ts','/src/index.tsx','/app/server.ts']");const Us=_s(Rt);export{Us as default};

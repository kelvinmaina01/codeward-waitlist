var kr=Object.defineProperty;var Ht=e=>{throw TypeError(e)};var Cr=(e,t,r)=>t in e?kr(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var b=(e,t,r)=>Cr(e,typeof t!="symbol"?t+"":t,r),ft=(e,t,r)=>t.has(e)||Ht("Cannot "+r);var u=(e,t,r)=>(ft(e,t,"read from private field"),r?r.call(e):t.get(e)),w=(e,t,r)=>t.has(e)?Ht("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,r),g=(e,t,r,s)=>(ft(e,t,"write to private field"),s?s.call(e,r):t.set(e,r),r),R=(e,t,r)=>(ft(e,t,"access private method"),r);var It=(e,t,r,s)=>({set _(n){g(e,t,n,r)},get _(){return u(e,t,s)}});import{Http2ServerRequest as qe,constants as Ar}from"http2";import{Readable as Mt}from"stream";import Or from"crypto";var Ut=(e,t,r)=>(s,n)=>{let a=-1;return o(0);async function o(l){if(l<=a)throw new Error("next() called multiple times");a=l;let p,i=!1,c;if(e[l]?(c=e[l][0][0],s.req.routeIndex=l):c=l===e.length&&n||void 0,c)try{p=await c(s,()=>o(l+1))}catch(d){if(d instanceof Error&&t)s.error=d,p=await t(d,s),i=!0;else throw d}else s.finalized===!1&&r&&(p=await r(s));return p&&(s.finalized===!1||i)&&(s.res=p),s}},Pr=Symbol(),Tr=(e,t)=>new Response(e,{headers:{"Content-Type":t.replace(/^[^;]+/,s=>s.toLowerCase())}}).formData(),xt=e=>"headers"in e,Lr=async(e,t=Object.create(null))=>{const{all:r=!1,dot:s=!1}=t,a=(xt(e)?e.headers:e.raw.headers).get("Content-Type"),o=a==null?void 0:a.split(";")[0].trim().toLowerCase();return o==="multipart/form-data"||o==="application/x-www-form-urlencoded"?_r(e,{all:r,dot:s}):{}};async function _r(e,t){const r=xt(e)?e.headers:e.raw.headers,s=await e.arrayBuffer(),n=Tr(s,r.get("Content-Type")||"");xt(e)||(e.bodyCache.formData=n);const a=await n;return a?$r(a,t):{}}function $r(e,t){const r=Object.create(null);return e.forEach((s,n)=>{t.all||n.endsWith("[]")?jr(r,n,s):r[n]=s}),t.dot&&Object.entries(r).forEach(([s,n])=>{s.includes(".")&&(Dr(r,s,n),delete r[s])}),r}var jr=(e,t,r)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(r):e[t]=[e[t],r]:t.endsWith("[]")?e[t]=[r]:e[t]=r},Dr=(e,t,r)=>{if(/(?:^|\.)__proto__\./.test(t))return;let s=e;const n=t.split(".");n.forEach((a,o)=>{o===n.length-1?s[a]=r:((!s[a]||typeof s[a]!="object"||Array.isArray(s[a])||s[a]instanceof File)&&(s[a]=Object.create(null)),s=s[a])})},Xt=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},Nr=e=>{const{groups:t,path:r}=Hr(e),s=Xt(r);return Ir(s,t)},Hr=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(r,s)=>{const n=`@${s}`;return t.push([n,r]),n}),{groups:t,path:e}},Ir=(e,t)=>{for(let r=t.length-1;r>=0;r--){const[s]=t[r];for(let n=e.length-1;n>=0;n--)if(e[n].includes(s)){e[n]=e[n].replace(s,t[r][1]);break}}return e},et={},Mr=(e,t)=>{if(e==="*")return"*";const r=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(r){const s=`${e}#${t}`;return et[s]||(r[2]?et[s]=t&&t[0]!==":"&&t[0]!=="*"?[s,r[1],new RegExp(`^${r[2]}(?=/${t})`)]:[e,r[1],new RegExp(`^${r[2]}$`)]:et[s]=[e,r[1],!0]),et[s]}return null},pt=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,r=>{try{return t(r)}catch{return r}})}},Ur=e=>pt(e,decodeURI),Qt=e=>{const t=e.url,r=t.indexOf("/",t.indexOf(":")+4);let s=r;for(;s<t.length;s++){const n=t.charCodeAt(s);if(n===37){const a=t.indexOf("?",s),o=t.indexOf("#",s),l=a===-1?o===-1?void 0:o:o===-1?a:Math.min(a,o),p=t.slice(r,l);return Ur(p.includes("%25")?p.replace(/%25/g,"%2525"):p)}else if(n===63||n===35)break}return t.slice(r,s)},qr=e=>{const t=Qt(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},ie=(e,t,...r)=>(r.length&&(t=ie(t,...r)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),Zt=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),r=[];let s="";return t.forEach(n=>{if(n!==""&&!/\:/.test(n))s+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){r.length===0&&s===""?r.push("/"):r.push(s);const a=n.replace("?","");s+="/"+a,r.push(s)}else s+="/"+n}),r.filter((n,a,o)=>o.indexOf(n)===a)},mt=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?pt(e,Ct):e):e,er=(e,t,r)=>{let s;if(!r&&t&&!/[%+]/.test(t)){let o=e.indexOf("?",8);if(o===-1)return;for(e.startsWith(t,o+1)||(o=e.indexOf(`&${t}`,o+1));o!==-1;){const l=e.charCodeAt(o+t.length+1);if(l===61){const p=o+t.length+2,i=e.indexOf("&",p);return mt(e.slice(p,i===-1?void 0:i))}else if(l==38||isNaN(l))return"";o=e.indexOf(`&${t}`,o+1)}if(s=/[%+]/.test(e),!s)return}const n={};s??(s=/[%+]/.test(e));let a=e.indexOf("?",8);for(;a!==-1;){const o=e.indexOf("&",a+1);let l=e.indexOf("=",a);l>o&&o!==-1&&(l=-1);let p=e.slice(a+1,l===-1?o===-1?void 0:o:l);if(s&&(p=mt(p)),a=o,p==="")continue;let i;l===-1?i="":(i=e.slice(l+1,o===-1?void 0:o),s&&(i=mt(i))),r?(n[p]&&Array.isArray(n[p])||(n[p]=[]),n[p].push(i)):n[p]??(n[p]=i)}return t?n[t]:n},Fr=er,zr=(e,t)=>er(e,t,!0),Ct=decodeURIComponent,qt=e=>pt(e,Ct),Ce,D,G,tr,rr,Et,q,Wt,Br=(Wt=class{constructor(e,t="/",r=[[]]){w(this,G);b(this,"raw");w(this,Ce);w(this,D);b(this,"routeIndex",0);b(this,"path");b(this,"bodyCache",{});w(this,q,e=>{const{bodyCache:t,raw:r}=this,s=t[e];if(s)return s;const n=Object.keys(t)[0];return n?t[n].then(a=>(n==="json"&&(a=JSON.stringify(a)),new Response(a)[e]())):t[e]=r[e]()});this.raw=e,this.path=t,g(this,D,r),g(this,Ce,{})}param(e){return e?R(this,G,tr).call(this,e):R(this,G,rr).call(this)}query(e){return Fr(this.url,e)}queries(e){return zr(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((r,s)=>{t[s]=r}),t}async parseBody(e){return Lr(this,e)}json(){return u(this,q).call(this,"text").then(e=>JSON.parse(e))}text(){return u(this,q).call(this,"text")}arrayBuffer(){return u(this,q).call(this,"arrayBuffer")}bytes(){return u(this,q).call(this,"arrayBuffer").then(e=>new Uint8Array(e))}blob(){return u(this,q).call(this,"blob")}formData(){return u(this,q).call(this,"formData")}addValidatedData(e,t){u(this,Ce)[e]=t}valid(e){return u(this,Ce)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[Pr](){return u(this,D)}get matchedRoutes(){return u(this,D)[0].map(([[,e]])=>e)}get routePath(){return u(this,D)[0].map(([[,e]])=>e)[this.routeIndex].path}},Ce=new WeakMap,D=new WeakMap,G=new WeakSet,tr=function(e){const t=u(this,D)[0][this.routeIndex][1][e],r=R(this,G,Et).call(this,t);return r&&/\%/.test(r)?qt(r):r},rr=function(){const e={},t=Object.keys(u(this,D)[0][this.routeIndex][1]);for(const r of t){const s=R(this,G,Et).call(this,u(this,D)[0][this.routeIndex][1][r]);s!==void 0&&(e[r]=/\%/.test(s)?qt(s):s)}return e},Et=function(e){return u(this,D)[1]?u(this,D)[1][e]:e},q=new WeakMap,Wt),Wr={Stringify:1},sr=async(e,t,r,s,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const a=e.callbacks;return a!=null&&a.length?(n?n[0]+=e:n=[e],Promise.all(a.map(l=>l({phase:t,buffer:n,context:s}))).then(l=>Promise.all(l.filter(Boolean).map(p=>sr(p,t,!1,s,n))).then(()=>n[0]))):Promise.resolve(e)},Gr="text/plain; charset=UTF-8",gt=(e,t)=>({"Content-Type":e,...t}),Ie=(e,t)=>new Response(e,t),We,Ge,F,Ae,z,L,Ke,Oe,Pe,he,Ye,Ve,Q,Ee,Gt,Kr=(Gt=class{constructor(e,t){w(this,Q);w(this,We);w(this,Ge);b(this,"env",{});w(this,F);b(this,"finalized",!1);b(this,"error");w(this,Ae);w(this,z);w(this,L);w(this,Ke);w(this,Oe);w(this,Pe);w(this,he);w(this,Ye);w(this,Ve);b(this,"render",(...e)=>(u(this,Oe)??g(this,Oe,t=>this.html(t)),u(this,Oe).call(this,...e)));b(this,"setLayout",e=>g(this,Ke,e));b(this,"getLayout",()=>u(this,Ke));b(this,"setRenderer",e=>{g(this,Oe,e)});b(this,"header",(e,t,r)=>{this.finalized&&g(this,L,Ie(u(this,L).body,u(this,L)));const s=u(this,L)?u(this,L).headers:u(this,he)??g(this,he,new Headers);t===void 0?s.delete(e):r!=null&&r.append?s.append(e,t):s.set(e,t)});b(this,"status",e=>{g(this,Ae,e)});b(this,"set",(e,t)=>{u(this,F)??g(this,F,new Map),u(this,F).set(e,t)});b(this,"get",e=>u(this,F)?u(this,F).get(e):void 0);b(this,"newResponse",(...e)=>R(this,Q,Ee).call(this,...e));b(this,"body",(e,t,r)=>R(this,Q,Ee).call(this,e,t,r));b(this,"text",(e,t,r)=>!u(this,he)&&!u(this,Ae)&&!t&&!r&&!this.finalized?new Response(e):R(this,Q,Ee).call(this,e,t,gt(Gr,r)));b(this,"json",(e,t,r)=>R(this,Q,Ee).call(this,JSON.stringify(e),t,gt("application/json",r)));b(this,"html",(e,t,r)=>{const s=n=>R(this,Q,Ee).call(this,n,t,gt("text/html; charset=UTF-8",r));return typeof e=="object"?sr(e,Wr.Stringify,!1,{}).then(s):s(e)});b(this,"redirect",(e,t)=>{const r=String(e);return this.header("Location",/[^\x00-\xFF]/.test(r)?encodeURI(r):r),this.newResponse(null,t??302)});b(this,"notFound",()=>(u(this,Pe)??g(this,Pe,()=>Ie()),u(this,Pe).call(this,this)));g(this,We,e),t&&(g(this,z,t.executionCtx),this.env=t.env,g(this,Pe,t.notFoundHandler),g(this,Ve,t.path),g(this,Ye,t.matchResult))}get req(){return u(this,Ge)??g(this,Ge,new Br(u(this,We),u(this,Ve),u(this,Ye))),u(this,Ge)}get event(){if(u(this,z)&&"respondWith"in u(this,z))return u(this,z);throw Error("This context has no FetchEvent")}get executionCtx(){if(u(this,z))return u(this,z);throw Error("This context has no ExecutionContext")}get res(){return u(this,L)||g(this,L,Ie(null,{headers:u(this,he)??g(this,he,new Headers)}))}set res(e){if(u(this,L)&&e){e=Ie(e.body,e);for(const[t,r]of u(this,L).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const s=u(this,L).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of s)e.headers.append("set-cookie",n)}else e.headers.set(t,r)}g(this,L,e),this.finalized=!0}get var(){return u(this,F)?Object.fromEntries(u(this,F)):{}}},We=new WeakMap,Ge=new WeakMap,F=new WeakMap,Ae=new WeakMap,z=new WeakMap,L=new WeakMap,Ke=new WeakMap,Oe=new WeakMap,Pe=new WeakMap,he=new WeakMap,Ye=new WeakMap,Ve=new WeakMap,Q=new WeakSet,Ee=function(e,t,r){const s=u(this,L)?new Headers(u(this,L).headers):u(this,he)??new Headers;if(typeof t=="object"&&"headers"in t){const a=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[o,l]of a)o.toLowerCase()==="set-cookie"?s.append(o,l):s.set(o,l)}if(r)for(const[a,o]of Object.entries(r))if(typeof o=="string")s.set(a,o);else{s.delete(a);for(const l of o)s.append(a,l)}const n=typeof t=="number"?t:(t==null?void 0:t.status)??u(this,Ae);return Ie(e,{status:n,headers:s})},Gt),C="ALL",Yr="all",Vr=["get","post","put","delete","options","patch"],nr="Can not add a route since the matcher is already built.",ar=class extends Error{},Jr="__COMPOSED_HANDLER",Xr=e=>e.text("404 Not Found",404),Ft=(e,t)=>{if("getResponse"in e){const r=e.getResponse();return t.newResponse(r.body,r)}return console.error(e),t.text("Internal Server Error",500)},N,A,or,H,le,tt,rt,Te,Qr=(Te=class{constructor(t={}){w(this,A);b(this,"get");b(this,"post");b(this,"put");b(this,"delete");b(this,"options");b(this,"patch");b(this,"all");b(this,"on");b(this,"use");b(this,"router");b(this,"getPath");b(this,"_basePath","/");w(this,N,"/");b(this,"routes",[]);w(this,H,Xr);b(this,"errorHandler",Ft);b(this,"onError",t=>(this.errorHandler=t,this));b(this,"notFound",t=>(g(this,H,t),this));b(this,"fetch",(t,...r)=>R(this,A,rt).call(this,t,r[1],r[0],t.method));b(this,"request",(t,r,s,n)=>t instanceof Request?this.fetch(r?new Request(t,r):t,s,n):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${ie("/",t)}`,r),s,n)));b(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(R(this,A,rt).call(this,t.request,t,void 0,t.request.method))})});[...Vr,Yr].forEach(a=>{this[a]=(o,...l)=>(typeof o=="string"?g(this,N,o):R(this,A,le).call(this,a,u(this,N),o),l.forEach(p=>{R(this,A,le).call(this,a,u(this,N),p)}),this)}),this.on=(a,o,...l)=>{for(const p of[o].flat()){g(this,N,p);for(const i of[a].flat())l.map(c=>{R(this,A,le).call(this,i.toUpperCase(),u(this,N),c)})}return this},this.use=(a,...o)=>(typeof a=="string"?g(this,N,a):(g(this,N,"*"),o.unshift(a)),o.forEach(l=>{R(this,A,le).call(this,C,u(this,N),l)}),this);const{strict:s,...n}=t;Object.assign(this,n),this.getPath=s??!0?t.getPath??Qt:qr}route(t,r){const s=this.basePath(t);return r.routes.map(n=>{var o;let a;r.errorHandler===Ft?a=n.handler:(a=async(l,p)=>(await Ut([],r.errorHandler)(l,()=>n.handler(l,p))).res,a[Jr]=n.handler),R(o=s,A,le).call(o,n.method,n.path,a,n.basePath)}),this}basePath(t){const r=R(this,A,or).call(this);return r._basePath=ie(this._basePath,t),r}mount(t,r,s){let n,a;s&&(typeof s=="function"?a=s:(a=s.optionHandler,s.replaceRequest===!1?n=p=>p:n=s.replaceRequest));const o=a?p=>{const i=a(p);return Array.isArray(i)?i:[i]}:p=>{let i;try{i=p.executionCtx}catch{}return[p.env,i]};n||(n=(()=>{const p=ie(this._basePath,t),i=p==="/"?0:p.length;return c=>{const d=new URL(c.url);return d.pathname=this.getPath(c).slice(i)||"/",new Request(d,c)}})());const l=async(p,i)=>{const c=await r(n(p.req.raw),...o(p));if(c)return c;await i()};return R(this,A,le).call(this,C,ie(t,"*"),l),this}},N=new WeakMap,A=new WeakSet,or=function(){const t=new Te({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,g(t,H,u(this,H)),t.routes=this.routes,t},H=new WeakMap,le=function(t,r,s,n){t=t.toUpperCase(),r=ie(this._basePath,r);const a={basePath:n!==void 0?ie(this._basePath,n):this._basePath,path:r,method:t,handler:s};this.router.add(t,r,[s,a]),this.routes.push(a)},tt=function(t,r){if(t instanceof Error)return this.errorHandler(t,r);throw t},rt=function(t,r,s,n){if(n==="HEAD")return(async()=>new Response(null,await R(this,A,rt).call(this,t,r,s,"GET")))();const a=this.getPath(t,{env:s}),o=this.router.match(n,a),l=new Kr(t,{path:a,matchResult:o,env:s,executionCtx:r,notFoundHandler:u(this,H)});if(o[0].length===1){let i;try{i=o[0][0][0][0](l,async()=>{l.res=await u(this,H).call(this,l)})}catch(c){return R(this,A,tt).call(this,c,l)}return i instanceof Promise?i.then(c=>c||(l.finalized?l.res:u(this,H).call(this,l))).catch(c=>R(this,A,tt).call(this,c,l)):i??u(this,H).call(this,l)}const p=Ut(o[0],this.errorHandler,u(this,H));return(async()=>{try{const i=await p(l);if(!i.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return i.res}catch(i){return R(this,A,tt).call(this,i,l)}})()},Te),ir=[];function Zr(e,t){const r=this.buildAllMatchers(),s=((n,a)=>{const o=r[n]||r[C],l=o[2][a];if(l)return l;const p=a.match(o[0]);if(!p)return[[],ir];const i=p.indexOf("",1);return[o[1][i],p]});return this.match=s,s(e,t)}var it="[^/]+",Fe=".*",ze="(?:|/.*)",Re=Symbol(),es=new Set(".\\+*[^]$()");function ts(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===Fe||e===ze?1:t===Fe||t===ze?-1:e===it?1:t===it?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var ue,fe,I,ve,rs=(ve=class{constructor(){w(this,ue);w(this,fe);w(this,I,Object.create(null))}insert(t,r,s,n,a){if(t.length===0){if(u(this,ue)!==void 0)throw Re;if(a)return;g(this,ue,r);return}const[o,...l]=t,p=o==="*"?l.length===0?["","",Fe]:["","",it]:o==="/*"?["","",ze]:o.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let i;if(p){const c=p[1];let d=p[2]||it;if(c&&p[2]&&(d===".*"||(d=d.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(d))))throw Re;if(i=u(this,I)[d],!i){if(Object.keys(u(this,I)).some(h=>h!==Fe&&h!==ze))throw Re;if(a)return;i=u(this,I)[d]=new ve,c!==""&&g(i,fe,n.varIndex++)}!a&&c!==""&&s.push([c,u(i,fe)])}else if(i=u(this,I)[o],!i){if(Object.keys(u(this,I)).some(c=>c.length>1&&c!==Fe&&c!==ze))throw Re;if(a)return;i=u(this,I)[o]=new ve}i.insert(l,r,s,n,a)}buildRegExpStr(){const r=Object.keys(u(this,I)).sort(ts).map(s=>{const n=u(this,I)[s];return(typeof u(n,fe)=="number"?`(${s})@${u(n,fe)}`:es.has(s)?`\\${s}`:s)+n.buildRegExpStr()});return typeof u(this,ue)=="number"&&r.unshift(`#${u(this,ue)}`),r.length===0?"":r.length===1?r[0]:"(?:"+r.join("|")+")"}},ue=new WeakMap,fe=new WeakMap,I=new WeakMap,ve),ct,Je,Kt,ss=(Kt=class{constructor(){w(this,ct,{varIndex:0});w(this,Je,new rs)}insert(e,t,r){const s=[],n=[];for(let o=0;;){let l=!1;if(e=e.replace(/\{[^}]+\}/g,p=>{const i=`@\\${o}`;return n[o]=[i,p],o++,l=!0,i}),!l)break}const a=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let o=n.length-1;o>=0;o--){const[l]=n[o];for(let p=a.length-1;p>=0;p--)if(a[p].indexOf(l)!==-1){a[p]=a[p].replace(l,n[o][1]);break}}return u(this,Je).insert(a,t,s,u(this,ct),r),s}buildRegExp(){let e=u(this,Je).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const r=[],s=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,a,o)=>a!==void 0?(r[++t]=Number(a),"$()"):(o!==void 0&&(s[Number(o)]=++t),"")),[new RegExp(`^${e}`),r,s]}},ct=new WeakMap,Je=new WeakMap,Kt),ns=[/^$/,[],Object.create(null)],st=Object.create(null);function lr(e){return st[e]??(st[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,r)=>r?`\\${r}`:"(?:|/.*)")}$`))}function as(){st=Object.create(null)}function os(e){var i;const t=new ss,r=[];if(e.length===0)return ns;const s=e.map(c=>[!/\*|\/:/.test(c[0]),...c]).sort(([c,d],[h,m])=>c?1:h?-1:d.length-m.length),n=Object.create(null);for(let c=0,d=-1,h=s.length;c<h;c++){const[m,f,y]=s[c];m?n[f]=[y.map(([x])=>[x,Object.create(null)]),ir]:d++;let v;try{v=t.insert(f,d,m)}catch(x){throw x===Re?new ar(f):x}m||(r[d]=y.map(([x,E])=>{const k=Object.create(null);for(E-=1;E>=0;E--){const[O,Ne]=v[E];k[O]=Ne}return[x,k]}))}const[a,o,l]=t.buildRegExp();for(let c=0,d=r.length;c<d;c++)for(let h=0,m=r[c].length;h<m;h++){const f=(i=r[c][h])==null?void 0:i[1];if(!f)continue;const y=Object.keys(f);for(let v=0,x=y.length;v<x;v++)f[y[v]]=l[f[y[v]]]}const p=[];for(const c in o)p[c]=r[o[c]];return[a,p,n]}function we(e,t){if(e){for(const r of Object.keys(e).sort((s,n)=>n.length-s.length))if(lr(r).test(t))return[...e[r]]}}var Z,ee,dt,cr,Yt,is=(Yt=class{constructor(){w(this,dt);b(this,"name","RegExpRouter");w(this,Z);w(this,ee);b(this,"match",Zr);g(this,Z,{[C]:Object.create(null)}),g(this,ee,{[C]:Object.create(null)})}add(e,t,r){var l;const s=u(this,Z),n=u(this,ee);if(!s||!n)throw new Error(nr);s[e]||[s,n].forEach(p=>{p[e]=Object.create(null),Object.keys(p[C]).forEach(i=>{p[e][i]=[...p[C][i]]})}),t==="/*"&&(t="*");const a=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const p=lr(t);e===C?Object.keys(s).forEach(i=>{var c;(c=s[i])[t]||(c[t]=we(s[i],t)||we(s[C],t)||[])}):(l=s[e])[t]||(l[t]=we(s[e],t)||we(s[C],t)||[]),Object.keys(s).forEach(i=>{(e===C||e===i)&&Object.keys(s[i]).forEach(c=>{p.test(c)&&s[i][c].push([r,a])})}),Object.keys(n).forEach(i=>{(e===C||e===i)&&Object.keys(n[i]).forEach(c=>p.test(c)&&n[i][c].push([r,a]))});return}const o=Zt(t)||[t];for(let p=0,i=o.length;p<i;p++){const c=o[p];Object.keys(n).forEach(d=>{var h;(e===C||e===d)&&((h=n[d])[c]||(h[c]=[...we(s[d],c)||we(s[C],c)||[]]),n[d][c].push([r,a-i+p+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(u(this,ee)).concat(Object.keys(u(this,Z))).forEach(t=>{e[t]||(e[t]=R(this,dt,cr).call(this,t))}),g(this,Z,g(this,ee,void 0)),as(),e}},Z=new WeakMap,ee=new WeakMap,dt=new WeakSet,cr=function(e){const t=[];let r=e===C;return[u(this,Z),u(this,ee)].forEach(s=>{const n=s[e]?Object.keys(s[e]).map(a=>[a,s[e][a]]):[];n.length!==0?(r||(r=!0),t.push(...n)):e!==C&&t.push(...Object.keys(s[C]).map(a=>[a,s[C][a]]))}),r?os(t):null},Yt),te,B,Vt,ls=(Vt=class{constructor(e){b(this,"name","SmartRouter");w(this,te,[]);w(this,B,[]);g(this,te,e.routers)}add(e,t,r){if(!u(this,B))throw new Error(nr);u(this,B).push([e,t,r])}match(e,t){if(!u(this,B))throw new Error("Fatal error");const r=u(this,te),s=u(this,B),n=r.length;let a=0,o;for(;a<n;a++){const l=r[a];try{for(let p=0,i=s.length;p<i;p++)l.add(...s[p]);o=l.match(e,t)}catch(p){if(p instanceof ar)continue;throw p}this.match=l.match.bind(l),g(this,te,[l]),g(this,B,void 0);break}if(a===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,o}get activeRouter(){if(u(this,B)||u(this,te).length!==1)throw new Error("No active router has been determined yet.");return u(this,te)[0]}},te=new WeakMap,B=new WeakMap,Vt),Me=Object.create(null),cs=e=>{for(const t in e)return!0;return!1},re,P,me,Le,T,U,V,_e,ds=(_e=class{constructor(t,r,s){w(this,U);w(this,re);w(this,P);w(this,me);w(this,Le,0);w(this,T,Me);if(g(this,P,s||Object.create(null)),g(this,re,[]),t&&r){const n=Object.create(null);n[t]={handler:r,possibleKeys:[],score:0},g(this,re,[n])}g(this,me,[])}insert(t,r,s){g(this,Le,++It(this,Le)._);let n=this;const a=Nr(r),o=[];for(let l=0,p=a.length;l<p;l++){const i=a[l],c=a[l+1],d=Mr(i,c),h=Array.isArray(d)?d[0]:i;if(h in u(n,P)){n=u(n,P)[h],d&&o.push(d[1]);continue}u(n,P)[h]=new _e,d&&(u(n,me).push(d),o.push(d[1])),n=u(n,P)[h]}return u(n,re).push({[t]:{handler:s,possibleKeys:o.filter((l,p,i)=>i.indexOf(l)===p),score:u(this,Le)}}),n}search(t,r){var c;const s=[];g(this,T,Me);let a=[this];const o=Xt(r),l=[],p=o.length;let i=null;for(let d=0;d<p;d++){const h=o[d],m=d===p-1,f=[];for(let v=0,x=a.length;v<x;v++){const E=a[v],k=u(E,P)[h];k&&(g(k,T,u(E,T)),m?(u(k,P)["*"]&&R(this,U,V).call(this,s,u(k,P)["*"],t,u(E,T)),R(this,U,V).call(this,s,k,t,u(E,T))):f.push(k));for(let O=0,Ne=u(E,me).length;O<Ne;O++){const ye=u(E,me)[O],j=u(E,T)===Me?{}:{...u(E,T)};if(ye==="*"){const K=u(E,P)["*"];K&&(R(this,U,V).call(this,s,K,t,u(E,T)),g(K,T,j),f.push(K));continue}const[ht,Ze,ae]=ye;if(!h&&!(ae instanceof RegExp))continue;const $=u(E,P)[ht];if(ae instanceof RegExp){if(i===null){i=new Array(p);let Y=r[0]==="/"?1:0;for(let oe=0;oe<p;oe++)i[oe]=Y,Y+=o[oe].length+1}const K=r.substring(i[d]),be=ae.exec(K);if(be){if(j[Ze]=be[0],R(this,U,V).call(this,s,$,t,u(E,T),j),be[0].length===K.length&&u($,P)["*"]&&R(this,U,V).call(this,s,u($,P)["*"],t,u(E,T),j),cs(u($,P))){g($,T,j);const Y=((c=be[0].match(/\//))==null?void 0:c.length)??0;(l[Y]||(l[Y]=[])).push($)}continue}}(ae===!0||ae.test(h))&&(j[Ze]=h,m?(R(this,U,V).call(this,s,$,t,j,u(E,T)),u($,P)["*"]&&R(this,U,V).call(this,s,u($,P)["*"],t,j,u(E,T))):(g($,T,j),f.push($)))}}const y=l.shift();a=y?f.concat(y):f}return s.length>1&&s.sort((d,h)=>d.score-h.score),[s.map(({handler:d,params:h})=>[d,h])]}},re=new WeakMap,P=new WeakMap,me=new WeakMap,Le=new WeakMap,T=new WeakMap,U=new WeakSet,V=function(t,r,s,n,a){for(let o=0,l=u(r,re).length;o<l;o++){const p=u(r,re)[o],i=p[s]||p[C],c={};if(i!==void 0&&(i.params=Object.create(null),t.push(i),n!==Me||a&&a!==Me))for(let d=0,h=i.possibleKeys.length;d<h;d++){const m=i.possibleKeys[d],f=c[i.score];i.params[m]=a!=null&&a[m]&&!f?a[m]:n[m]??(a==null?void 0:a[m]),c[i.score]=!0}}},_e),ge,Jt,ps=(Jt=class{constructor(){b(this,"name","TrieRouter");w(this,ge);g(this,ge,new ds)}add(e,t,r){const s=Zt(t);if(s){for(let n=0,a=s.length;n<a;n++)u(this,ge).insert(e,s[n],r);return}u(this,ge).insert(e,t,r)}match(e,t){return u(this,ge).search(e,t)}},ge=new WeakMap,Jt),At=class extends Qr{constructor(e={}){super(e),this.router=e.router??new ls({routers:[new is,new ps]})}},dr=/^[\w!#$%&'*.^`|~+-]+$/,hs=/^[ !#-:<-[\]-~]*$/,zt=e=>{let t=0,r=e.length;for(;t<r;){const s=e.charCodeAt(t);if(s!==32&&s!==9)break;t++}for(;r>t;){const s=e.charCodeAt(r-1);if(s!==32&&s!==9)break;r--}return t===0&&r===e.length?e:e.slice(t,r)},us=(e,t)=>{if(t&&e.indexOf(t)===-1)return{};const r=e.split(";"),s=Object.create(null);for(const n of r){const a=n.indexOf("=");if(a===-1)continue;const o=zt(n.substring(0,a));if(t&&t!==o||!dr.test(o)||o in s)continue;let l=zt(n.substring(a+1));if(l.startsWith('"')&&l.endsWith('"')&&(l=l.slice(1,-1)),hs.test(l)&&(s[o]=l.indexOf("%")!==-1?pt(l,Ct):l,t))break}return s},fs=(e,t,r={})=>{if(!dr.test(e))throw new Error("Invalid cookie name");let s=`${e}=${t}`;if(e.startsWith("__Secure-")&&!r.secure)throw new Error("__Secure- Cookie must have Secure attributes");if(e.startsWith("__Host-")){if(!r.secure)throw new Error("__Host- Cookie must have Secure attributes");if(r.path!=="/")throw new Error('__Host- Cookie must have Path attributes with "/"');if(r.domain)throw new Error("__Host- Cookie must not have Domain attributes")}for(const n of["domain","path","sameSite","priority"])if(r[n]&&/[;\r\n]/.test(r[n]))throw new Error(`${n} must not contain ";", "\\r", or "\\n"`);if(r&&typeof r.maxAge=="number"&&r.maxAge>=0){if(r.maxAge>3456e4)throw new Error("Cookies Max-Age SHOULD NOT be greater than 400 days (34560000 seconds) in duration.");s+=`; Max-Age=${r.maxAge|0}`}if(r.domain&&r.prefix!=="host"&&(s+=`; Domain=${r.domain}`),r.path&&(s+=`; Path=${r.path}`),r.expires){if(r.expires.getTime()-Date.now()>3456e7)throw new Error("Cookies Expires SHOULD NOT be greater than 400 days (34560000 seconds) in the future.");s+=`; Expires=${r.expires.toUTCString()}`}if(r.httpOnly&&(s+="; HttpOnly"),r.secure&&(s+="; Secure"),r.sameSite&&(s+=`; SameSite=${r.sameSite.charAt(0).toUpperCase()+r.sameSite.slice(1)}`),r.priority&&(s+=`; Priority=${r.priority.charAt(0).toUpperCase()+r.priority.slice(1)}`),r.partitioned){if(!r.secure)throw new Error("Partitioned Cookie must have Secure attributes");s+="; Partitioned"}return s},vt=(e,t,r)=>(t=encodeURIComponent(t),fs(e,t,r)),pr=(e,t,r)=>{const s=e.req.raw.headers.get("Cookie");{if(!s)return;let n=t;return r==="secure"?n="__Secure-"+t:r==="host"&&(n="__Host-"+t),us(s,n)[n]}},ms=(e,t,r)=>{let s;return(r==null?void 0:r.prefix)==="secure"?s=vt("__Secure-"+e,t,{path:"/",...r,secure:!0}):(r==null?void 0:r.prefix)==="host"?s=vt("__Host-"+e,t,{...r,path:"/",secure:!0,domain:void 0}):s=vt(e,t,{path:"/",...r}),s},hr=(e,t,r,s)=>{const n=ms(t,r,s);e.header("Set-Cookie",n,{append:!0})},gs=(e,t,r)=>{const s=pr(e,t,r==null?void 0:r.prefix);return hr(e,t,"",{...r,maxAge:0}),s};typeof process<"u"&&process.env&&(process.env.POSTGRES_URL=process.env.POSTGRES_URL||process.env.DATABASE_POSTGRES_URL||process.env.DATABASE_URL);function Ot(e){return J(e)}const se=new At;se.use("*",async(e,t)=>{const r=new URL(e.req.url).pathname;if(r==="/admin/login"||r.startsWith("/static/"))return t();const s=e.env.ADMIN_PASSWORD||process.env.ADMIN_PASSWORD||"paraKenya8#";return pr(e,"codeward_admin_session")===s?t():e.redirect("/admin/login")});se.get("/login",e=>{const t=`<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8"/>
...
</html>`;return e.html(t)});se.post("/login",async e=>{const t=await e.req.parseBody(),r=e.env.ADMIN_USERNAME||process.env.ADMIN_USERNAME||"kelvin.reallife8@gmail.com",s=e.env.ADMIN_PASSWORD||process.env.ADMIN_PASSWORD||"paraKenya8#";return t.username===r&&t.password===s?(hr(e,"codeward_admin_session",s,{path:"/admin",httpOnly:!0,secure:!0,maxAge:3600*24*7}),e.redirect("/admin")):e.redirect("/admin/login?error=1")});se.get("/logout",e=>(gs(e,"codeward_admin_session",{path:"/admin"}),e.redirect("/admin/login")));const nt={"software-engineer":"Software Engineer","senior-engineer":"Senior / Staff Engineer","engineering-lead":"Engineering Lead / Manager","cto-vp":"CTO / VP of Engineering","devops-platform":"DevOps / Platform Engineer","security-engineer":"Security Engineer",freelancer:"Freelance Developer","open-source":"Open Source Contributor",student:"Student / Bootcamp",founder:"Founder / Indie Hacker",other:"Other"};function M(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function xe(e){if(e==null)return"";const t=String(e);return/[",\n]/.test(t)?'"'+t.replace(/"/g,'""')+'"':t}se.get("/",async e=>{var Lt,_t,$t,jt,Dt,Nt;const{env:t}=e,r=new URL(e.req.url),s=(r.searchParams.get("q")||"").trim(),n=(r.searchParams.get("role")||"").trim(),a=Math.max(1,parseInt(r.searchParams.get("page")||"1",10)||1),o=25,l=r.searchParams.get("msg")||"";let p="";l==="retrigger_success"?p='<div style="background: rgba(16, 185, 129, 0.1); border: 1px solid rgba(16, 185, 129, 0.3); color: #10b981; padding: 12px 16px; border-radius: 8px; margin-bottom: 24px; font-weight: 500; display: flex; align-items: center; gap: 8px;"><svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"></path></svg> Email successfully resent!</div>':l==="retrigger_failed"&&(p='<div style="background: rgba(239, 68, 68, 0.1); border: 1px solid rgba(239, 68, 68, 0.3); color: #ef4444; padding: 12px 16px; border-radius: 8px; margin-bottom: 24px; font-weight: 500; display: flex; align-items: center; gap: 8px;"><svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12"></path></svg> Failed to resend email. Please check the logs.</div>');let i="WHERE 1=1";const c=[];let d=1;if(s){i+=` AND (LOWER(name) LIKE $${d++} OR LOWER(email) LIKE $${d++} OR LOWER(company) LIKE $${d++})`;const S=`%${s.toLowerCase()}%`;c.push(S,S,S)}n&&(i+=` AND role = $${d++}`,c.push(n));const h=await Ot(e).connect(),m=await h.query(`SELECT COUNT(*) as cnt FROM waitlist_entries ${i}`,c),f=Number(((Lt=m.rows[0])==null?void 0:Lt.cnt)??0),y=Math.max(1,Math.ceil(f/o)),v=Math.min(a,y),x=(v-1)*o,E=[...c,o,x],O=(await h.query(`SELECT id, name, email, role, company, github, position, created_at, email_sent, linkedin_clicked
...
<div class="admin-page">
  ...
  <section class="stats-row" style="grid-template-columns: repeat(auto-fit, minmax(140px, 1fr));">
    ...
    <div class="stat-card">
      <span class="stat-num">${oe.toLocaleString()}</span>
...
</html>`;return e.html(Rr)});se.get("/export.csv",async e=>{const{env:t}=e,r=new URL(e.req.url),s=(r.searchParams.get("q")||"").trim(),n=(r.searchParams.get("role")||"").trim();let a="WHERE 1=1";const o=[];let l=1;if(s){a+=` AND (LOWER(name) LIKE $${l++} OR LOWER(email) LIKE $${l++} OR LOWER(company) LIKE $${l++})`;const f=`%${s.toLowerCase()}%`;o.push(f,f,f)}n&&(a+=` AND role = $${l++}`,o.push(n));const c=(await(await Ot(e).connect()).query(`SELECT id, name, email, role, company, github, position, created_at
     FROM waitlist_entries ${a}
     ORDER BY created_at ASC`,o)).rows||[],h=[["Position","Name","Email","Role","Company","GitHub","Joined At (UTC)"].join(",")];for(const f of c)h.push([616+f.position,xe(f.name),xe(f.email),xe(nt[f.role]||f.role),xe(f.company||""),xe(f.github||""),xe(f.created_at)].join(","));const m=h.join(`
`);return new Response(m,{headers:{"Content-Type":"text/csv; charset=utf-8","Content-Disposition":`attachment; filename="codeward-waitlist-${new Date().toISOString().slice(0,10)}.csv"`}})});se.post("/retrigger",async e=>{const{env:t}=e,s=((await e.req.parseBody()).email||"").toString().trim();if(!s)return e.redirect("/admin");const n=await Ot(e).connect(),o=(await n.query("SELECT name, position FROM waitlist_entries WHERE email = $1",[s])).rows[0];return o&&await ur(t,s,o.name,o.position)?(await n.query("UPDATE waitlist_entries SET email_sent = 1 WHERE email = $1",[s]),e.redirect("/admin?msg=retrigger_success")):e.redirect("/admin?msg=retrigger_failed")});typeof process<"u"&&process.env&&(process.env.POSTGRES_URL=process.env.POSTGRES_URL||process.env.DATABASE_POSTGRES_URL||process.env.DATABASE_URL);function vs(e){const s=`https://${new URL(e).hostname}/sql`;async function n(o,l=[]){const p=await fetch(s,{method:"POST",headers:{"Content-Type":"application/json","Neon-Connection-String":e},body:JSON.stringify({query:o,params:l})});if(!p.ok){const c=await p.text();throw new Error(`DB error ${p.status}: ${c}`)}const i=await p.json();return{rows:i.rows??[],rowCount:i.rowCount??0}}async function a(o,...l){let p="";const i=[];return o.forEach((c,d)=>{p+=c,d<l.length&&(i.push(l[d]===void 0?null:l[d]),p+=`$${i.length}`)}),n(p,i)}return a.connect=async()=>({query:n,release:()=>{}}),a.query=n,a}let yt=null;function J(e){var t,r,s;if(!yt){const n=((t=e==null?void 0:e.env)==null?void 0:t.POSTGRES_URL)||((r=e==null?void 0:e.env)==null?void 0:r.DATABASE_POSTGRES_URL)||((s=e==null?void 0:e.env)==null?void 0:s.DATABASE_URL)||(typeof process<"u"&&process.env?process.env.POSTGRES_URL||process.env.DATABASE_POSTGRES_URL||process.env.DATABASE_URL:void 0);if(!n)throw new Error("No database connection string found in environment");yt=vs(n)}return yt}function Se(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}const ne=new At;ne.onError((e,t)=>(console.error("Hono Global Error:",e),t.json({error:e.message||"Internal Server Error"},500)));ne.route("/admin",se);const ce=617;ne.get("/api/stats",async e=>{var n;const{env:t}=e,{rows:r}=await J(e)`SELECT COUNT(*) as cnt FROM waitlist_entries`,s=Number(((n=r[0])==null?void 0:n.cnt)??0);return e.json({count:ce+s})});function ys(e){function t(f,y){const v=(f&65535)+(y&65535);return(f>>16)+(y>>16)+(v>>16)<<16|v&65535}function r(f,y){return f<<y|f>>>32-y}function s(f,y,v,x,E,k){return t(r(t(t(y,f),t(x,k)),E),v)}function n(f,y,v,x,E,k,O){return s(y&v|~y&x,f,y,E,k,O)}function a(f,y,v,x,E,k,O){return s(y&x|v&~x,f,y,E,k,O)}function o(f,y,v,x,E,k,O){return s(y^v^x,f,y,E,k,O)}function l(f,y,v,x,E,k,O){return s(v^(y|~x),f,y,E,k,O)}function p(f){const y=(f.length+8>>6)+1,v=new Array(y*16).fill(0);for(let x=0;x<f.length;x++)v[x>>2]|=f.charCodeAt(x)<<x%4*8;return v[f.length>>2]|=128<<f.length%4*8,v[y*16-2]=f.length*8,v}const i=p(e.toLowerCase().trim());let c=1732584193,d=-271733879,h=-1732584194,m=271733878;for(let f=0;f<i.length;f+=16){const[y,v,x,E]=[c,d,h,m];c=n(c,d,h,m,i[f+0],7,-680876936),d=n(m,c,d,h,i[f+1],12,-389564586),h=n(h,m,c,d,i[f+2],17,606105819),m=n(d,h,m,c,i[f+3],22,-1044525330),c=n(c,d,h,m,i[f+4],7,-176418897),d=n(m,c,d,h,i[f+5],12,1200080426),h=n(h,m,c,d,i[f+6],17,-1473231341),m=n(d,h,m,c,i[f+7],22,-45705983),c=n(c,d,h,m,i[f+8],7,1770035416),d=n(m,c,d,h,i[f+9],12,-1958414417),h=n(h,m,c,d,i[f+10],17,-42063),m=n(d,h,m,c,i[f+11],22,-1990404162),c=n(c,d,h,m,i[f+12],7,1804603682),d=n(m,c,d,h,i[f+13],12,-40341101),h=n(h,m,c,d,i[f+14],17,-1502002290),m=n(d,h,m,c,i[f+15],22,1236535329),c=a(c,d,h,m,i[f+1],5,-165796510),d=a(m,c,d,h,i[f+6],9,-1069501632),h=a(h,m,c,d,i[f+11],14,643717713),m=a(d,h,m,c,i[f+0],20,-373897302),c=a(c,d,h,m,i[f+5],5,-701558691),d=a(m,c,d,h,i[f+10],9,38016083),h=a(h,m,c,d,i[f+15],14,-660478335),m=a(d,h,m,c,i[f+4],20,-405537848),c=a(c,d,h,m,i[f+9],5,568446438),d=a(m,c,d,h,i[f+14],9,-1019803690),h=a(h,m,c,d,i[f+3],14,-187363961),m=a(d,h,m,c,i[f+8],20,1163531501),c=a(c,d,h,m,i[f+13],5,-1444681467),d=a(m,c,d,h,i[f+2],9,-51403784),h=a(h,m,c,d,i[f+7],14,1735328473),m=a(d,h,m,c,i[f+12],20,-1926607734),c=o(c,d,h,m,i[f+5],4,-378558),d=o(m,c,d,h,i[f+8],11,-2022574463),h=o(h,m,c,d,i[f+11],16,1839030562),m=o(d,h,m,c,i[f+14],23,-35309556),c=o(c,d,h,m,i[f+1],4,-1530992060),d=o(m,c,d,h,i[f+4],11,1272893353),h=o(h,m,c,d,i[f+7],16,-155497632),m=o(d,h,m,c,i[f+10],23,-1094730640),c=o(c,d,h,m,i[f+13],4,681279174),d=o(m,c,d,h,i[f+0],11,-358537222),h=o(h,m,c,d,i[f+3],16,-722521979),m=o(d,h,m,c,i[f+6],23,76029189),c=o(c,d,h,m,i[f+9],4,-640364487),d=o(m,c,d,h,i[f+12],11,-421815835),h=o(h,m,c,d,i[f+15],16,530742520),m=o(d,h,m,c,i[f+2],23,-995338651),c=l(c,d,h,m,i[f+0],6,-198630844),d=l(m,c,d,h,i[f+7],10,1126891415),h=l(h,m,c,d,i[f+14],15,-1416354905),m=l(d,h,m,c,i[f+5],21,-57434055),c=l(c,d,h,m,i[f+12],6,1700485571),d=l(m,c,d,h,i[f+3],10,-1894986606),h=l(h,m,c,d,i[f+10],15,-1051523),m=l(d,h,m,c,i[f+1],21,-2054922799),c=l(c,d,h,m,i[f+8],6,1873313359),d=l(m,c,d,h,i[f+15],10,-30611744),h=l(h,m,c,d,i[f+6],15,-1560198380),m=l(d,h,m,c,i[f+13],21,1309151649),c=l(c,d,h,m,i[f+4],6,-145523070),d=l(m,c,d,h,i[f+11],10,-1120210379),h=l(h,m,c,d,i[f+2],15,718787259),m=l(d,h,m,c,i[f+9],21,-343485551),c=t(c,y),d=t(d,v),h=t(h,x),m=t(m,E)}return[c,d,h,m].map(f=>{let y="";for(let v=0;v<4;v++)y+=("0"+(f>>v*8&255).toString(16)).slice(-2);return y}).join("")}ne.get("/api/avatars",async e=>{try{const{rows:t}=await J(e)`SELECT name, email FROM waitlist_entries ORDER BY id DESC LIMIT 8`,r=t.map(s=>{let n="";try{n=ys(s.email||"")}catch{}const a=(s.name||"").trim(),o=a.split(" ")[0]||"",l=a.split(" ")[1]||"";return{initials:((o[0]||"")+(l[0]||"")).toUpperCase()||"?",emailHash:n}});return e.json({avatars:r},200,{"Cache-Control":"public, max-age=60"})}catch{return e.json({avatars:[]})}});ne.post("/api/join",async e=>{const{env:t}=e;let r;try{r=await e.req.json()}catch{return e.json({error:"Invalid request body"},400)}const s=(r.name||"").toString().trim(),n=(r.email||"").toString().trim().toLowerCase(),a=(r.role||"").toString().trim(),o=(r.company||"").toString().trim(),l=(r.github||"").toString().trim();if(s.length<2)return e.json({error:"Please enter your full name."},400);if(!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(n))return e.json({error:"Please enter a valid email address."},400);if(!a)return e.json({error:"Please select your role."},400);const{rows:p}=await J(e)`SELECT id, position FROM waitlist_entries WHERE email = ${n}`,i=p[0];if(i){const{rows:y}=await J(e)`SELECT COUNT(*) as cnt FROM waitlist_entries`,v=y[0];return e.json({alreadyJoined:!0,position:ce+Number(i.position),total:ce+Number((v==null?void 0:v.cnt)??0)})}const{rows:c}=await J(e)`SELECT COUNT(*) as cnt FROM waitlist_entries`,d=c[0],h=Number((d==null?void 0:d.cnt)??0)+1;await J(e)`INSERT INTO waitlist_entries (name, email, role, company, github, position) VALUES (${s}, ${n}, ${a}, ${o||null}, ${l||null}, ${h})`;let m=0;if(process.env.RESEND_API_KEY){await ur(t,n,s,h)&&(m=1);try{await bs(t,s,n,a,o,l,ce+h)}catch(v){console.error("Failed sending admin notification email:",v)}}return await J(e)`UPDATE waitlist_entries SET email_sent = ${m} WHERE email = ${n}`,e.json({success:!0,position:ce+h,total:ce+Number((d==null?void 0:d.cnt)??0)+1})});async function ur(e,t,r,s){const n=e.RESEND_API_KEY||process.env.RESEND_API_KEY;if(!n)return!1;try{const a=(ce+s).toLocaleString(),o=`<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8" />
...
</html>`;var de=class extends Error{constructor(e,t){super(e,t),this.name="RequestError"}},xs=e=>e instanceof de?e:new de(e.message,{cause:e}),Es=global.Request,Be=class extends Es{constructor(t,r){var s;typeof t=="object"&&je in t&&(t=t[je]()),typeof((s=r==null?void 0:r.body)==null?void 0:s.getReader)<"u"&&(r.duplex??(r.duplex="half")),super(t,r)}},Rs=e=>{const t=[],r=e.rawHeaders;for(let s=0;s<r.length;s+=2){const{[s]:n,[s+1]:a}=r;n.charCodeAt(0)!==58&&t.push([n,a])}return new Headers(t)},fr=Symbol("wrapBodyStream"),Ss=(e,t,r,s,n)=>{const a={method:e,headers:r,signal:n.signal};if(e==="TRACE"){a.method="GET";const o=new Be(t,a);return Object.defineProperty(o,"method",{get(){return"TRACE"}}),o}if(!(e==="GET"||e==="HEAD"))if("rawBody"in s&&s.rawBody instanceof Buffer)a.body=new ReadableStream({start(o){o.enqueue(s.rawBody),o.close()}});else if(s[fr]){let o;a.body=new ReadableStream({async pull(l){try{o||(o=Mt.toWeb(s).getReader());const{done:p,value:i}=await o.read();p?l.close():l.enqueue(i)}catch(p){l.error(p)}}})}else a.body=Mt.toWeb(s);return new Be(t,a)},je=Symbol("getRequestCache"),at=Symbol("requestCache"),ot=Symbol("incomingKey"),lt=Symbol("urlKey"),bt=Symbol("headersKey"),X=Symbol("abortControllerKey"),ks=Symbol("getAbortController"),Qe={get method(){return this[ot].method||"GET"},get url(){return this[lt]},get headers(){return this[bt]||(this[bt]=Rs(this[ot]))},[ks](){return this[je](),this[X]},[je](){return this[X]||(this[X]=new AbortController),this[at]||(this[at]=Ss(this.method,this[lt],this.headers,this[ot],this[X]))}};["body","bodyUsed","cache","credentials","destination","integrity","mode","redirect","referrer","referrerPolicy","signal","keepalive"].forEach(e=>{Object.defineProperty(Qe,e,{get(){return this[je]()[e]}})});["arrayBuffer","blob","clone","formData","json","text"].forEach(e=>{Object.defineProperty(Qe,e,{value:function(){return this[je]()[e]()}})});Object.defineProperty(Qe,Symbol.for("nodejs.util.inspect.custom"),{value:function(e,t,r){const s={method:this.method,url:this.url,headers:this.headers,nativeRequest:this[at]};return`Request (lightweight) ${r(s,{...t,depth:e==null?null:e-1})}`}});Object.setPrototypeOf(Qe,Be.prototype);var Cs=(e,t)=>{const r=Object.create(Qe);r[ot]=e;const s=e.url||"";if(s[0]!=="/"&&(s.startsWith("http://")||s.startsWith("https://"))){if(e instanceof qe)throw new de("Absolute URL for :path is not allowed in HTTP/2");try{const l=new URL(s);r[lt]=l.href}catch(l){throw new de("Invalid absolute URL",{cause:l})}return r}const n=(e instanceof qe?e.authority:e.headers.host)||t;if(!n)throw new de("Missing host header");let a;if(e instanceof qe){if(a=e.scheme,!(a==="http"||a==="https"))throw new de("Unsupported scheme")}else a=e.socket&&e.socket.encrypted?"https":"http";const o=new URL(`${a}://${n}${s}`);if(o.hostname.length!==n.length&&o.hostname!==n.replace(/:\d+$/,""))throw new de("Invalid host header");return r[lt]=o.href,r},Ue=Symbol("responseCache"),ke=Symbol("getResponseCache"),pe=Symbol("cache"),Pt=global.Response,Xe,W,$e,De=($e=class{constructor(t,r){w(this,Xe);w(this,W);let s;if(g(this,Xe,t),r instanceof $e){const n=r[Ue];if(n){g(this,W,n),this[ke]();return}else g(this,W,u(r,W)),s=new Headers(u(r,W).headers)}else g(this,W,r);(typeof t=="string"||typeof(t==null?void 0:t.getReader)<"u"||t instanceof Blob||t instanceof Uint8Array)&&(this[pe]=[(r==null?void 0:r.status)||200,t,s||(r==null?void 0:r.headers)])}[ke](){return delete this[pe],this[Ue]||(this[Ue]=new Pt(u(this,Xe),u(this,W)))}get headers(){const t=this[pe];return t?(t[2]instanceof Headers||(t[2]=new Headers(t[2]||{"content-type":"text/plain; charset=UTF-8"})),t[2]):this[ke]().headers}get status(){var t;return((t=this[pe])==null?void 0:t[0])??this[ke]().status}get ok(){const t=this.status;return t>=200&&t<300}},Xe=new WeakMap,W=new WeakMap,$e);["body","bodyUsed","redirected","statusText","trailers","type","url"].forEach(e=>{Object.defineProperty(De.prototype,e,{get(){return this[ke]()[e]}})});["arrayBuffer","blob","clone","formData","json","text"].forEach(e=>{Object.defineProperty(De.prototype,e,{value:function(){return this[ke]()[e]()}})});Object.defineProperty(De.prototype,Symbol.for("nodejs.util.inspect.custom"),{value:function(e,t,r){const s={status:this.status,headers:this.headers,ok:this.ok,nativeResponse:this[Ue]};return`Response (lightweight) ${r(s,{...t,depth:e==null?null:e-1})}`}});Object.setPrototypeOf(De,Pt);Object.setPrototypeOf(De.prototype,Pt.prototype);async function As(e){return Promise.race([e,Promise.resolve().then(()=>Promise.resolve(void 0))])}function mr(e,t,r){const s=l=>{e.cancel(l).catch(()=>{})};return t.on("close",s),t.on("error",s),(r??e.read()).then(o,n),e.closed.finally(()=>{t.off("close",s),t.off("error",s)});function n(l){l&&t.destroy(l)}function a(){e.read().then(o,n)}function o({done:l,value:p}){try{if(l)t.end();else if(!t.write(p))t.once("drain",a);else return e.read().then(o,n)}catch(i){n(i)}}}function Os(e,t){if(e.locked)throw new TypeError("ReadableStream is locked.");return t.destroyed?void 0:mr(e.getReader(),t)}var Rt=e=>{const t={};e instanceof Headers||(e=new Headers(e??void 0));const r=[];for(const[s,n]of e)s==="set-cookie"?r.push(n):t[s]=n;return r.length>0&&(t["set-cookie"]=r),t["content-type"]??(t["content-type"]="text/plain; charset=UTF-8"),t},Ps="x-hono-already-sent";typeof global.crypto>"u"&&(global.crypto=Or);var Tt=Symbol("outgoingEnded"),Bt=Symbol("incomingDraining"),Ts=500,Ls=64*1024*1024,wt=e=>{var l,p,i;const t=e;if(e.destroyed||t[Bt])return;if(t[Bt]=!0,e instanceof qe){try{(p=(l=e.stream)==null?void 0:l.close)==null||p.call(l,Ar.NGHTTP2_NO_ERROR)}catch{}return}let r=0;const s=()=>{clearTimeout(a),e.off("data",o),e.off("end",s),e.off("error",s)},n=()=>{s();const c=e.socket;c&&!c.destroyed&&c.destroySoon()},a=setTimeout(n,Ts);(i=a.unref)==null||i.call(a);const o=c=>{r+=c.length,r>Ls&&n()};e.on("data",o),e.on("end",s),e.on("error",s),e.resume()},_s=()=>new Response(null,{status:400}),gr=e=>new Response(null,{status:e instanceof Error&&(e.name==="TimeoutError"||e.constructor.name==="TimeoutError")?504:500}),St=(e,t)=>{const r=e instanceof Error?e:new Error("unknown error",{cause:e});r.code==="ERR_STREAM_PREMATURE_CLOSE"?console.info("The user aborted a request."):(console.error(e),t.headersSent||t.writeHead(500,{"Content-Type":"text/plain"}),t.end(`Error: ${r.message}`),t.destroy(r))},vr=e=>{"flushHeaders"in e&&e.writable&&e.flushHeaders()},yr=async(e,t)=>{var o,l;let[r,s,n]=e[pe],a=!1;if(!n)n={"content-type":"text/plain; charset=UTF-8"};else if(n instanceof Headers)a=n.has("content-length"),n=Rt(n);else if(Array.isArray(n)){const p=new Headers(n);a=p.has("content-length"),n=Rt(p)}else for(const p in n)if(p.length===14&&p.toLowerCase()==="content-length"){a=!0;break}a||(typeof s=="string"?n["Content-Length"]=Buffer.byteLength(s):s instanceof Uint8Array?n["Content-Length"]=s.byteLength:s instanceof Blob&&(n["Content-Length"]=s.size)),t.writeHead(r,n),typeof s=="string"||s instanceof Uint8Array?t.end(s):s instanceof Blob?t.end(new Uint8Array(await s.arrayBuffer())):(vr(t),await((o=Os(s,t))==null?void 0:o.catch(p=>St(p,t)))),(l=t[Tt])==null||l.call(t)},$s=e=>typeof e.then=="function",js=async(e,t,r={})=>{var n;if($s(e))if(r.errorHandler)try{e=await e}catch(a){const o=await r.errorHandler(a);if(!o)return;e=o}else e=await e.catch(gr);if(pe in e)return yr(e,t);const s=Rt(e.headers);if(e.body){const a=e.body.getReader(),o=[];let l=!1,p;if(s["transfer-encoding"]!=="chunked"){let i=2;for(let c=0;c<i;c++){p||(p=a.read());const d=await As(p).catch(h=>{console.error(h),l=!0});if(!d){if(c===1){await new Promise(h=>setTimeout(h)),i=3;continue}break}if(p=void 0,d.value&&o.push(d.value),d.done){l=!0;break}}l&&!("content-length"in s)&&(s["content-length"]=o.reduce((c,d)=>c+d.length,0))}t.writeHead(e.status,s),o.forEach(i=>{t.write(i)}),l?t.end():(o.length===0&&vr(t),await mr(a,t,p))}else s[Ps]||(t.writeHead(e.status,s),t.end());(n=t[Tt])==null||n.call(t)},Ds=(e,t={})=>{const r=t.autoCleanupIncoming??!0;return t.overrideGlobalObjects!==!1&&global.Request!==Be&&(Object.defineProperty(global,"Request",{value:Be}),Object.defineProperty(global,"Response",{value:De})),async(s,n)=>{let a,o;try{o=Cs(s,t.hostname);let l=!r||s.method==="GET"||s.method==="HEAD";if(l||(s[fr]=!0,s.on("end",()=>{l=!0}),s instanceof qe&&(n[Tt]=()=>{l||setTimeout(()=>{l||setTimeout(()=>{wt(s)})})}),n.on("finish",()=>{l||wt(s)})),n.on("close",()=>{o[X]&&(s.errored?o[X].abort(s.errored.toString()):n.writableFinished||o[X].abort("Client connection prematurely closed.")),l||setTimeout(()=>{l||setTimeout(()=>{wt(s)})})}),a=e(o,{incoming:s,outgoing:n}),pe in a)return yr(a,n)}catch(l){if(a)return St(l,n);if(t.errorHandler){if(a=await t.errorHandler(o?l:xs(l)),!a)return}else o?a=gr(l):a=_s()}try{return await js(a,n,t)}catch(l){return St(l,n)}}},Ns=e=>Ds(e.fetch);const kt=new At,Hs=Object.assign({"/src/index.tsx":ne});let br=!1;for(const[,e]of Object.entries(Hs))e&&(kt.all("*",t=>{let r;try{r=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,r)}),kt.notFound(t=>{let r;try{r=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,r)}),br=!0);if(!br)throw new Error("Can't import modules from ['/src/index.ts','/src/index.tsx','/app/server.ts']");const zs=Ns(kt);export{zs as default};

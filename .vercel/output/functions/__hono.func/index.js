var Sr=Object.defineProperty;var Ht=e=>{throw TypeError(e)};var kr=(e,t,r)=>t in e?Sr(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var y=(e,t,r)=>kr(e,typeof t!="symbol"?t+"":t,r),ut=(e,t,r)=>t.has(e)||Ht("Cannot "+r);var h=(e,t,r)=>(ut(e,t,"read from private field"),r?r.call(e):t.get(e)),w=(e,t,r)=>t.has(e)?Ht("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,r),m=(e,t,r,s)=>(ut(e,t,"write to private field"),s?s.call(e,r):t.set(e,r),r),R=(e,t,r)=>(ut(e,t,"access private method"),r);var Nt=(e,t,r,s)=>({set _(n){m(e,t,n,r)},get _(){return h(e,t,s)}});import{Http2ServerRequest as Ue,constants as Cr}from"http2";import{Readable as Mt}from"stream";import Or from"crypto";var It=(e,t,r)=>(s,n)=>{let a=-1;return i(0);async function i(l){if(l<=a)throw new Error("next() called multiple times");a=l;let p,o=!1,c;if(e[l]?(c=e[l][0][0],s.req.routeIndex=l):c=l===e.length&&n||void 0,c)try{p=await c(s,()=>i(l+1))}catch(d){if(d instanceof Error&&t)s.error=d,p=await t(d,s),o=!0;else throw d}else s.finalized===!1&&r&&(p=await r(s));return p&&(s.finalized===!1||o)&&(s.res=p),s}},Ar=Symbol(),Tr=(e,t)=>new Response(e,{headers:{"Content-Type":t.replace(/^[^;]+/,s=>s.toLowerCase())}}).formData(),wt=e=>"headers"in e,Lr=async(e,t=Object.create(null))=>{const{all:r=!1,dot:s=!1}=t,a=(wt(e)?e.headers:e.raw.headers).get("Content-Type"),i=a==null?void 0:a.split(";")[0].trim().toLowerCase();return i==="multipart/form-data"||i==="application/x-www-form-urlencoded"?Pr(e,{all:r,dot:s}):{}};async function Pr(e,t){const r=wt(e)?e.headers:e.raw.headers,s=await e.arrayBuffer(),n=Tr(s,r.get("Content-Type")||"");wt(e)||(e.bodyCache.formData=n);const a=await n;return a?_r(a,t):{}}function _r(e,t){const r=Object.create(null);return e.forEach((s,n)=>{t.all||n.endsWith("[]")?$r(r,n,s):r[n]=s}),t.dot&&Object.entries(r).forEach(([s,n])=>{s.includes(".")&&(jr(r,s,n),delete r[s])}),r}var $r=(e,t,r)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(r):e[t]=[e[t],r]:t.endsWith("[]")?e[t]=[r]:e[t]=r},jr=(e,t,r)=>{if(/(?:^|\.)__proto__\./.test(t))return;let s=e;const n=t.split(".");n.forEach((a,i)=>{i===n.length-1?s[a]=r:((!s[a]||typeof s[a]!="object"||Array.isArray(s[a])||s[a]instanceof File)&&(s[a]=Object.create(null)),s=s[a])})},Jt=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},Dr=e=>{const{groups:t,path:r}=Hr(e),s=Jt(r);return Nr(s,t)},Hr=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(r,s)=>{const n=`@${s}`;return t.push([n,r]),n}),{groups:t,path:e}},Nr=(e,t)=>{for(let r=t.length-1;r>=0;r--){const[s]=t[r];for(let n=e.length-1;n>=0;n--)if(e[n].includes(s)){e[n]=e[n].replace(s,t[r][1]);break}}return e},Ze={},Mr=(e,t)=>{if(e==="*")return"*";const r=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(r){const s=`${e}#${t}`;return Ze[s]||(r[2]?Ze[s]=t&&t[0]!==":"&&t[0]!=="*"?[s,r[1],new RegExp(`^${r[2]}(?=/${t})`)]:[e,r[1],new RegExp(`^${r[2]}$`)]:Ze[s]=[e,r[1],!0]),Ze[s]}return null},dt=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,r=>{try{return t(r)}catch{return r}})}},Ir=e=>dt(e,decodeURI),Qt=e=>{const t=e.url,r=t.indexOf("/",t.indexOf(":")+4);let s=r;for(;s<t.length;s++){const n=t.charCodeAt(s);if(n===37){const a=t.indexOf("?",s),i=t.indexOf("#",s),l=a===-1?i===-1?void 0:i:i===-1?a:Math.min(a,i),p=t.slice(r,l);return Ir(p.includes("%25")?p.replace(/%25/g,"%2525"):p)}else if(n===63||n===35)break}return t.slice(r,s)},Ur=e=>{const t=Qt(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},oe=(e,t,...r)=>(r.length&&(t=oe(t,...r)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),Xt=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),r=[];let s="";return t.forEach(n=>{if(n!==""&&!/\:/.test(n))s+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){r.length===0&&s===""?r.push("/"):r.push(s);const a=n.replace("?","");s+="/"+a,r.push(s)}else s+="/"+n}),r.filter((n,a,i)=>i.indexOf(n)===a)},ft=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?dt(e,kt):e):e,Zt=(e,t,r)=>{let s;if(!r&&t&&!/[%+]/.test(t)){let i=e.indexOf("?",8);if(i===-1)return;for(e.startsWith(t,i+1)||(i=e.indexOf(`&${t}`,i+1));i!==-1;){const l=e.charCodeAt(i+t.length+1);if(l===61){const p=i+t.length+2,o=e.indexOf("&",p);return ft(e.slice(p,o===-1?void 0:o))}else if(l==38||isNaN(l))return"";i=e.indexOf(`&${t}`,i+1)}if(s=/[%+]/.test(e),!s)return}const n={};s??(s=/[%+]/.test(e));let a=e.indexOf("?",8);for(;a!==-1;){const i=e.indexOf("&",a+1);let l=e.indexOf("=",a);l>i&&i!==-1&&(l=-1);let p=e.slice(a+1,l===-1?i===-1?void 0:i:l);if(s&&(p=ft(p)),a=i,p==="")continue;let o;l===-1?o="":(o=e.slice(l+1,i===-1?void 0:i),s&&(o=ft(o))),r?(n[p]&&Array.isArray(n[p])||(n[p]=[]),n[p].push(o)):n[p]??(n[p]=o)}return t?n[t]:n},qr=Zt,Fr=(e,t)=>Zt(e,t,!0),kt=decodeURIComponent,Ut=e=>dt(e,kt),ke,D,G,er,tr,xt,q,Bt,zr=(Bt=class{constructor(e,t="/",r=[[]]){w(this,G);y(this,"raw");w(this,ke);w(this,D);y(this,"routeIndex",0);y(this,"path");y(this,"bodyCache",{});w(this,q,e=>{const{bodyCache:t,raw:r}=this,s=t[e];if(s)return s;const n=Object.keys(t)[0];return n?t[n].then(a=>(n==="json"&&(a=JSON.stringify(a)),new Response(a)[e]())):t[e]=r[e]()});this.raw=e,this.path=t,m(this,D,r),m(this,ke,{})}param(e){return e?R(this,G,er).call(this,e):R(this,G,tr).call(this)}query(e){return qr(this.url,e)}queries(e){return Fr(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((r,s)=>{t[s]=r}),t}async parseBody(e){return Lr(this,e)}json(){return h(this,q).call(this,"text").then(e=>JSON.parse(e))}text(){return h(this,q).call(this,"text")}arrayBuffer(){return h(this,q).call(this,"arrayBuffer")}bytes(){return h(this,q).call(this,"arrayBuffer").then(e=>new Uint8Array(e))}blob(){return h(this,q).call(this,"blob")}formData(){return h(this,q).call(this,"formData")}addValidatedData(e,t){h(this,ke)[e]=t}valid(e){return h(this,ke)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[Ar](){return h(this,D)}get matchedRoutes(){return h(this,D)[0].map(([[,e]])=>e)}get routePath(){return h(this,D)[0].map(([[,e]])=>e)[this.routeIndex].path}},ke=new WeakMap,D=new WeakMap,G=new WeakSet,er=function(e){const t=h(this,D)[0][this.routeIndex][1][e],r=R(this,G,xt).call(this,t);return r&&/\%/.test(r)?Ut(r):r},tr=function(){const e={},t=Object.keys(h(this,D)[0][this.routeIndex][1]);for(const r of t){const s=R(this,G,xt).call(this,h(this,D)[0][this.routeIndex][1][r]);s!==void 0&&(e[r]=/\%/.test(s)?Ut(s):s)}return e},xt=function(e){return h(this,D)[1]?h(this,D)[1][e]:e},q=new WeakMap,Bt),Br={Stringify:1},rr=async(e,t,r,s,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const a=e.callbacks;return a!=null&&a.length?(n?n[0]+=e:n=[e],Promise.all(a.map(l=>l({phase:t,buffer:n,context:s}))).then(l=>Promise.all(l.filter(Boolean).map(p=>rr(p,t,!1,s,n))).then(()=>n[0]))):Promise.resolve(e)},Wr="text/plain; charset=UTF-8",gt=(e,t)=>({"Content-Type":e,...t}),Ne=(e,t)=>new Response(e,t),Be,We,F,Ce,z,P,Ge,Oe,Ae,pe,Ke,Ye,X,xe,Wt,Gr=(Wt=class{constructor(e,t){w(this,X);w(this,Be);w(this,We);y(this,"env",{});w(this,F);y(this,"finalized",!1);y(this,"error");w(this,Ce);w(this,z);w(this,P);w(this,Ge);w(this,Oe);w(this,Ae);w(this,pe);w(this,Ke);w(this,Ye);y(this,"render",(...e)=>(h(this,Oe)??m(this,Oe,t=>this.html(t)),h(this,Oe).call(this,...e)));y(this,"setLayout",e=>m(this,Ge,e));y(this,"getLayout",()=>h(this,Ge));y(this,"setRenderer",e=>{m(this,Oe,e)});y(this,"header",(e,t,r)=>{this.finalized&&m(this,P,Ne(h(this,P).body,h(this,P)));const s=h(this,P)?h(this,P).headers:h(this,pe)??m(this,pe,new Headers);t===void 0?s.delete(e):r!=null&&r.append?s.append(e,t):s.set(e,t)});y(this,"status",e=>{m(this,Ce,e)});y(this,"set",(e,t)=>{h(this,F)??m(this,F,new Map),h(this,F).set(e,t)});y(this,"get",e=>h(this,F)?h(this,F).get(e):void 0);y(this,"newResponse",(...e)=>R(this,X,xe).call(this,...e));y(this,"body",(e,t,r)=>R(this,X,xe).call(this,e,t,r));y(this,"text",(e,t,r)=>!h(this,pe)&&!h(this,Ce)&&!t&&!r&&!this.finalized?new Response(e):R(this,X,xe).call(this,e,t,gt(Wr,r)));y(this,"json",(e,t,r)=>R(this,X,xe).call(this,JSON.stringify(e),t,gt("application/json",r)));y(this,"html",(e,t,r)=>{const s=n=>R(this,X,xe).call(this,n,t,gt("text/html; charset=UTF-8",r));return typeof e=="object"?rr(e,Br.Stringify,!1,{}).then(s):s(e)});y(this,"redirect",(e,t)=>{const r=String(e);return this.header("Location",/[^\x00-\xFF]/.test(r)?encodeURI(r):r),this.newResponse(null,t??302)});y(this,"notFound",()=>(h(this,Ae)??m(this,Ae,()=>Ne()),h(this,Ae).call(this,this)));m(this,Be,e),t&&(m(this,z,t.executionCtx),this.env=t.env,m(this,Ae,t.notFoundHandler),m(this,Ye,t.path),m(this,Ke,t.matchResult))}get req(){return h(this,We)??m(this,We,new zr(h(this,Be),h(this,Ye),h(this,Ke))),h(this,We)}get event(){if(h(this,z)&&"respondWith"in h(this,z))return h(this,z);throw Error("This context has no FetchEvent")}get executionCtx(){if(h(this,z))return h(this,z);throw Error("This context has no ExecutionContext")}get res(){return h(this,P)||m(this,P,Ne(null,{headers:h(this,pe)??m(this,pe,new Headers)}))}set res(e){if(h(this,P)&&e){e=Ne(e.body,e);for(const[t,r]of h(this,P).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const s=h(this,P).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of s)e.headers.append("set-cookie",n)}else e.headers.set(t,r)}m(this,P,e),this.finalized=!0}get var(){return h(this,F)?Object.fromEntries(h(this,F)):{}}},Be=new WeakMap,We=new WeakMap,F=new WeakMap,Ce=new WeakMap,z=new WeakMap,P=new WeakMap,Ge=new WeakMap,Oe=new WeakMap,Ae=new WeakMap,pe=new WeakMap,Ke=new WeakMap,Ye=new WeakMap,X=new WeakSet,xe=function(e,t,r){const s=h(this,P)?new Headers(h(this,P).headers):h(this,pe)??new Headers;if(typeof t=="object"&&"headers"in t){const a=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[i,l]of a)i.toLowerCase()==="set-cookie"?s.append(i,l):s.set(i,l)}if(r)for(const[a,i]of Object.entries(r))if(typeof i=="string")s.set(a,i);else{s.delete(a);for(const l of i)s.append(a,l)}const n=typeof t=="number"?t:(t==null?void 0:t.status)??h(this,Ce);return Ne(e,{status:n,headers:s})},Wt),C="ALL",Kr="all",Yr=["get","post","put","delete","options","patch"],sr="Can not add a route since the matcher is already built.",nr=class extends Error{},Vr="__COMPOSED_HANDLER",Jr=e=>e.text("404 Not Found",404),qt=(e,t)=>{if("getResponse"in e){const r=e.getResponse();return t.newResponse(r.body,r)}return console.error(e),t.text("Internal Server Error",500)},H,O,ar,N,le,et,tt,Te,Qr=(Te=class{constructor(t={}){w(this,O);y(this,"get");y(this,"post");y(this,"put");y(this,"delete");y(this,"options");y(this,"patch");y(this,"all");y(this,"on");y(this,"use");y(this,"router");y(this,"getPath");y(this,"_basePath","/");w(this,H,"/");y(this,"routes",[]);w(this,N,Jr);y(this,"errorHandler",qt);y(this,"onError",t=>(this.errorHandler=t,this));y(this,"notFound",t=>(m(this,N,t),this));y(this,"fetch",(t,...r)=>R(this,O,tt).call(this,t,r[1],r[0],t.method));y(this,"request",(t,r,s,n)=>t instanceof Request?this.fetch(r?new Request(t,r):t,s,n):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${oe("/",t)}`,r),s,n)));y(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(R(this,O,tt).call(this,t.request,t,void 0,t.request.method))})});[...Yr,Kr].forEach(a=>{this[a]=(i,...l)=>(typeof i=="string"?m(this,H,i):R(this,O,le).call(this,a,h(this,H),i),l.forEach(p=>{R(this,O,le).call(this,a,h(this,H),p)}),this)}),this.on=(a,i,...l)=>{for(const p of[i].flat()){m(this,H,p);for(const o of[a].flat())l.map(c=>{R(this,O,le).call(this,o.toUpperCase(),h(this,H),c)})}return this},this.use=(a,...i)=>(typeof a=="string"?m(this,H,a):(m(this,H,"*"),i.unshift(a)),i.forEach(l=>{R(this,O,le).call(this,C,h(this,H),l)}),this);const{strict:s,...n}=t;Object.assign(this,n),this.getPath=s??!0?t.getPath??Qt:Ur}route(t,r){const s=this.basePath(t);return r.routes.map(n=>{var i;let a;r.errorHandler===qt?a=n.handler:(a=async(l,p)=>(await It([],r.errorHandler)(l,()=>n.handler(l,p))).res,a[Vr]=n.handler),R(i=s,O,le).call(i,n.method,n.path,a,n.basePath)}),this}basePath(t){const r=R(this,O,ar).call(this);return r._basePath=oe(this._basePath,t),r}mount(t,r,s){let n,a;s&&(typeof s=="function"?a=s:(a=s.optionHandler,s.replaceRequest===!1?n=p=>p:n=s.replaceRequest));const i=a?p=>{const o=a(p);return Array.isArray(o)?o:[o]}:p=>{let o;try{o=p.executionCtx}catch{}return[p.env,o]};n||(n=(()=>{const p=oe(this._basePath,t),o=p==="/"?0:p.length;return c=>{const d=new URL(c.url);return d.pathname=this.getPath(c).slice(o)||"/",new Request(d,c)}})());const l=async(p,o)=>{const c=await r(n(p.req.raw),...i(p));if(c)return c;await o()};return R(this,O,le).call(this,C,oe(t,"*"),l),this}},H=new WeakMap,O=new WeakSet,ar=function(){const t=new Te({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,m(t,N,h(this,N)),t.routes=this.routes,t},N=new WeakMap,le=function(t,r,s,n){t=t.toUpperCase(),r=oe(this._basePath,r);const a={basePath:n!==void 0?oe(this._basePath,n):this._basePath,path:r,method:t,handler:s};this.router.add(t,r,[s,a]),this.routes.push(a)},et=function(t,r){if(t instanceof Error)return this.errorHandler(t,r);throw t},tt=function(t,r,s,n){if(n==="HEAD")return(async()=>new Response(null,await R(this,O,tt).call(this,t,r,s,"GET")))();const a=this.getPath(t,{env:s}),i=this.router.match(n,a),l=new Gr(t,{path:a,matchResult:i,env:s,executionCtx:r,notFoundHandler:h(this,N)});if(i[0].length===1){let o;try{o=i[0][0][0][0](l,async()=>{l.res=await h(this,N).call(this,l)})}catch(c){return R(this,O,et).call(this,c,l)}return o instanceof Promise?o.then(c=>c||(l.finalized?l.res:h(this,N).call(this,l))).catch(c=>R(this,O,et).call(this,c,l)):o??h(this,N).call(this,l)}const p=It(i[0],this.errorHandler,h(this,N));return(async()=>{try{const o=await p(l);if(!o.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return o.res}catch(o){return R(this,O,et).call(this,o,l)}})()},Te),ir=[];function Xr(e,t){const r=this.buildAllMatchers(),s=((n,a)=>{const i=r[n]||r[C],l=i[2][a];if(l)return l;const p=a.match(i[0]);if(!p)return[[],ir];const o=p.indexOf("",1);return[i[1][o],p]});return this.match=s,s(e,t)}var it="[^/]+",qe=".*",Fe="(?:|/.*)",Ee=Symbol(),Zr=new Set(".\\+*[^]$()");function es(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===qe||e===Fe?1:t===qe||t===Fe?-1:e===it?1:t===it?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var he,ue,M,me,ts=(me=class{constructor(){w(this,he);w(this,ue);w(this,M,Object.create(null))}insert(t,r,s,n,a){if(t.length===0){if(h(this,he)!==void 0)throw Ee;if(a)return;m(this,he,r);return}const[i,...l]=t,p=i==="*"?l.length===0?["","",qe]:["","",it]:i==="/*"?["","",Fe]:i.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let o;if(p){const c=p[1];let d=p[2]||it;if(c&&p[2]&&(d===".*"||(d=d.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(d))))throw Ee;if(o=h(this,M)[d],!o){if(Object.keys(h(this,M)).some(u=>u!==qe&&u!==Fe))throw Ee;if(a)return;o=h(this,M)[d]=new me,c!==""&&m(o,ue,n.varIndex++)}!a&&c!==""&&s.push([c,h(o,ue)])}else if(o=h(this,M)[i],!o){if(Object.keys(h(this,M)).some(c=>c.length>1&&c!==qe&&c!==Fe))throw Ee;if(a)return;o=h(this,M)[i]=new me}o.insert(l,r,s,n,a)}buildRegExpStr(){const r=Object.keys(h(this,M)).sort(es).map(s=>{const n=h(this,M)[s];return(typeof h(n,ue)=="number"?`(${s})@${h(n,ue)}`:Zr.has(s)?`\\${s}`:s)+n.buildRegExpStr()});return typeof h(this,he)=="number"&&r.unshift(`#${h(this,he)}`),r.length===0?"":r.length===1?r[0]:"(?:"+r.join("|")+")"}},he=new WeakMap,ue=new WeakMap,M=new WeakMap,me),lt,Ve,Gt,rs=(Gt=class{constructor(){w(this,lt,{varIndex:0});w(this,Ve,new ts)}insert(e,t,r){const s=[],n=[];for(let i=0;;){let l=!1;if(e=e.replace(/\{[^}]+\}/g,p=>{const o=`@\\${i}`;return n[i]=[o,p],i++,l=!0,o}),!l)break}const a=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let i=n.length-1;i>=0;i--){const[l]=n[i];for(let p=a.length-1;p>=0;p--)if(a[p].indexOf(l)!==-1){a[p]=a[p].replace(l,n[i][1]);break}}return h(this,Ve).insert(a,t,s,h(this,lt),r),s}buildRegExp(){let e=h(this,Ve).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const r=[],s=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,a,i)=>a!==void 0?(r[++t]=Number(a),"$()"):(i!==void 0&&(s[Number(i)]=++t),"")),[new RegExp(`^${e}`),r,s]}},lt=new WeakMap,Ve=new WeakMap,Gt),ss=[/^$/,[],Object.create(null)],rt=Object.create(null);function or(e){return rt[e]??(rt[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,r)=>r?`\\${r}`:"(?:|/.*)")}$`))}function ns(){rt=Object.create(null)}function as(e){var o;const t=new rs,r=[];if(e.length===0)return ss;const s=e.map(c=>[!/\*|\/:/.test(c[0]),...c]).sort(([c,d],[u,g])=>c?1:u?-1:d.length-g.length),n=Object.create(null);for(let c=0,d=-1,u=s.length;c<u;c++){const[g,f,b]=s[c];g?n[f]=[b.map(([x])=>[x,Object.create(null)]),ir]:d++;let v;try{v=t.insert(f,d,g)}catch(x){throw x===Ee?new nr(f):x}g||(r[d]=b.map(([x,E])=>{const k=Object.create(null);for(E-=1;E>=0;E--){const[A,De]=v[E];k[A]=De}return[x,k]}))}const[a,i,l]=t.buildRegExp();for(let c=0,d=r.length;c<d;c++)for(let u=0,g=r[c].length;u<g;u++){const f=(o=r[c][u])==null?void 0:o[1];if(!f)continue;const b=Object.keys(f);for(let v=0,x=b.length;v<x;v++)f[b[v]]=l[f[b[v]]]}const p=[];for(const c in i)p[c]=r[i[c]];return[a,p,n]}function ye(e,t){if(e){for(const r of Object.keys(e).sort((s,n)=>n.length-s.length))if(or(r).test(t))return[...e[r]]}}var Z,ee,ct,lr,Kt,is=(Kt=class{constructor(){w(this,ct);y(this,"name","RegExpRouter");w(this,Z);w(this,ee);y(this,"match",Xr);m(this,Z,{[C]:Object.create(null)}),m(this,ee,{[C]:Object.create(null)})}add(e,t,r){var l;const s=h(this,Z),n=h(this,ee);if(!s||!n)throw new Error(sr);s[e]||[s,n].forEach(p=>{p[e]=Object.create(null),Object.keys(p[C]).forEach(o=>{p[e][o]=[...p[C][o]]})}),t==="/*"&&(t="*");const a=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const p=or(t);e===C?Object.keys(s).forEach(o=>{var c;(c=s[o])[t]||(c[t]=ye(s[o],t)||ye(s[C],t)||[])}):(l=s[e])[t]||(l[t]=ye(s[e],t)||ye(s[C],t)||[]),Object.keys(s).forEach(o=>{(e===C||e===o)&&Object.keys(s[o]).forEach(c=>{p.test(c)&&s[o][c].push([r,a])})}),Object.keys(n).forEach(o=>{(e===C||e===o)&&Object.keys(n[o]).forEach(c=>p.test(c)&&n[o][c].push([r,a]))});return}const i=Xt(t)||[t];for(let p=0,o=i.length;p<o;p++){const c=i[p];Object.keys(n).forEach(d=>{var u;(e===C||e===d)&&((u=n[d])[c]||(u[c]=[...ye(s[d],c)||ye(s[C],c)||[]]),n[d][c].push([r,a-o+p+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(h(this,ee)).concat(Object.keys(h(this,Z))).forEach(t=>{e[t]||(e[t]=R(this,ct,lr).call(this,t))}),m(this,Z,m(this,ee,void 0)),ns(),e}},Z=new WeakMap,ee=new WeakMap,ct=new WeakSet,lr=function(e){const t=[];let r=e===C;return[h(this,Z),h(this,ee)].forEach(s=>{const n=s[e]?Object.keys(s[e]).map(a=>[a,s[e][a]]):[];n.length!==0?(r||(r=!0),t.push(...n)):e!==C&&t.push(...Object.keys(s[C]).map(a=>[a,s[C][a]]))}),r?as(t):null},Kt),te,B,Yt,os=(Yt=class{constructor(e){y(this,"name","SmartRouter");w(this,te,[]);w(this,B,[]);m(this,te,e.routers)}add(e,t,r){if(!h(this,B))throw new Error(sr);h(this,B).push([e,t,r])}match(e,t){if(!h(this,B))throw new Error("Fatal error");const r=h(this,te),s=h(this,B),n=r.length;let a=0,i;for(;a<n;a++){const l=r[a];try{for(let p=0,o=s.length;p<o;p++)l.add(...s[p]);i=l.match(e,t)}catch(p){if(p instanceof nr)continue;throw p}this.match=l.match.bind(l),m(this,te,[l]),m(this,B,void 0);break}if(a===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,i}get activeRouter(){if(h(this,B)||h(this,te).length!==1)throw new Error("No active router has been determined yet.");return h(this,te)[0]}},te=new WeakMap,B=new WeakMap,Yt),Me=Object.create(null),ls=e=>{for(const t in e)return!0;return!1},re,T,fe,Le,L,U,V,Pe,cs=(Pe=class{constructor(t,r,s){w(this,U);w(this,re);w(this,T);w(this,fe);w(this,Le,0);w(this,L,Me);if(m(this,T,s||Object.create(null)),m(this,re,[]),t&&r){const n=Object.create(null);n[t]={handler:r,possibleKeys:[],score:0},m(this,re,[n])}m(this,fe,[])}insert(t,r,s){m(this,Le,++Nt(this,Le)._);let n=this;const a=Dr(r),i=[];for(let l=0,p=a.length;l<p;l++){const o=a[l],c=a[l+1],d=Mr(o,c),u=Array.isArray(d)?d[0]:o;if(u in h(n,T)){n=h(n,T)[u],d&&i.push(d[1]);continue}h(n,T)[u]=new Pe,d&&(h(n,fe).push(d),i.push(d[1])),n=h(n,T)[u]}return h(n,re).push({[t]:{handler:s,possibleKeys:i.filter((l,p,o)=>o.indexOf(l)===p),score:h(this,Le)}}),n}search(t,r){var c;const s=[];m(this,L,Me);let a=[this];const i=Jt(r),l=[],p=i.length;let o=null;for(let d=0;d<p;d++){const u=i[d],g=d===p-1,f=[];for(let v=0,x=a.length;v<x;v++){const E=a[v],k=h(E,T)[u];k&&(m(k,L,h(E,L)),g?(h(k,T)["*"]&&R(this,U,V).call(this,s,h(k,T)["*"],t,h(E,L)),R(this,U,V).call(this,s,k,t,h(E,L))):f.push(k));for(let A=0,De=h(E,fe).length;A<De;A++){const ve=h(E,fe)[A],j=h(E,L)===Me?{}:{...h(E,L)};if(ve==="*"){const K=h(E,T)["*"];K&&(R(this,U,V).call(this,s,K,t,h(E,L)),m(K,L,j),f.push(K));continue}const[pt,Xe,ae]=ve;if(!u&&!(ae instanceof RegExp))continue;const $=h(E,T)[pt];if(ae instanceof RegExp){if(o===null){o=new Array(p);let Y=r[0]==="/"?1:0;for(let ie=0;ie<p;ie++)o[ie]=Y,Y+=i[ie].length+1}const K=r.substring(o[d]),be=ae.exec(K);if(be){if(j[Xe]=be[0],R(this,U,V).call(this,s,$,t,h(E,L),j),be[0].length===K.length&&h($,T)["*"]&&R(this,U,V).call(this,s,h($,T)["*"],t,h(E,L),j),ls(h($,T))){m($,L,j);const Y=((c=be[0].match(/\//))==null?void 0:c.length)??0;(l[Y]||(l[Y]=[])).push($)}continue}}(ae===!0||ae.test(u))&&(j[Xe]=u,g?(R(this,U,V).call(this,s,$,t,j,h(E,L)),h($,T)["*"]&&R(this,U,V).call(this,s,h($,T)["*"],t,j,h(E,L))):(m($,L,j),f.push($)))}}const b=l.shift();a=b?f.concat(b):f}return s.length>1&&s.sort((d,u)=>d.score-u.score),[s.map(({handler:d,params:u})=>[d,u])]}},re=new WeakMap,T=new WeakMap,fe=new WeakMap,Le=new WeakMap,L=new WeakMap,U=new WeakSet,V=function(t,r,s,n,a){for(let i=0,l=h(r,re).length;i<l;i++){const p=h(r,re)[i],o=p[s]||p[C],c={};if(o!==void 0&&(o.params=Object.create(null),t.push(o),n!==Me||a&&a!==Me))for(let d=0,u=o.possibleKeys.length;d<u;d++){const g=o.possibleKeys[d],f=c[o.score];o.params[g]=a!=null&&a[g]&&!f?a[g]:n[g]??(a==null?void 0:a[g]),c[o.score]=!0}}},Pe),ge,Vt,ds=(Vt=class{constructor(){y(this,"name","TrieRouter");w(this,ge);m(this,ge,new cs)}add(e,t,r){const s=Xt(t);if(s){for(let n=0,a=s.length;n<a;n++)h(this,ge).insert(e,s[n],r);return}h(this,ge).insert(e,t,r)}match(e,t){return h(this,ge).search(e,t)}},ge=new WeakMap,Vt),Ct=class extends Qr{constructor(e={}){super(e),this.router=e.router??new os({routers:[new is,new ds]})}},cr=/^[\w!#$%&'*.^`|~+-]+$/,ps=/^[ !#-:<-[\]-~]*$/,Ft=e=>{let t=0,r=e.length;for(;t<r;){const s=e.charCodeAt(t);if(s!==32&&s!==9)break;t++}for(;r>t;){const s=e.charCodeAt(r-1);if(s!==32&&s!==9)break;r--}return t===0&&r===e.length?e:e.slice(t,r)},hs=(e,t)=>{if(t&&e.indexOf(t)===-1)return{};const r=e.split(";"),s=Object.create(null);for(const n of r){const a=n.indexOf("=");if(a===-1)continue;const i=Ft(n.substring(0,a));if(t&&t!==i||!cr.test(i)||i in s)continue;let l=Ft(n.substring(a+1));if(l.startsWith('"')&&l.endsWith('"')&&(l=l.slice(1,-1)),ps.test(l)&&(s[i]=l.indexOf("%")!==-1?dt(l,kt):l,t))break}return s},us=(e,t,r={})=>{if(!cr.test(e))throw new Error("Invalid cookie name");let s=`${e}=${t}`;if(e.startsWith("__Secure-")&&!r.secure)throw new Error("__Secure- Cookie must have Secure attributes");if(e.startsWith("__Host-")){if(!r.secure)throw new Error("__Host- Cookie must have Secure attributes");if(r.path!=="/")throw new Error('__Host- Cookie must have Path attributes with "/"');if(r.domain)throw new Error("__Host- Cookie must not have Domain attributes")}for(const n of["domain","path","sameSite","priority"])if(r[n]&&/[;\r\n]/.test(r[n]))throw new Error(`${n} must not contain ";", "\\r", or "\\n"`);if(r&&typeof r.maxAge=="number"&&r.maxAge>=0){if(r.maxAge>3456e4)throw new Error("Cookies Max-Age SHOULD NOT be greater than 400 days (34560000 seconds) in duration.");s+=`; Max-Age=${r.maxAge|0}`}if(r.domain&&r.prefix!=="host"&&(s+=`; Domain=${r.domain}`),r.path&&(s+=`; Path=${r.path}`),r.expires){if(r.expires.getTime()-Date.now()>3456e7)throw new Error("Cookies Expires SHOULD NOT be greater than 400 days (34560000 seconds) in the future.");s+=`; Expires=${r.expires.toUTCString()}`}if(r.httpOnly&&(s+="; HttpOnly"),r.secure&&(s+="; Secure"),r.sameSite&&(s+=`; SameSite=${r.sameSite.charAt(0).toUpperCase()+r.sameSite.slice(1)}`),r.priority&&(s+=`; Priority=${r.priority.charAt(0).toUpperCase()+r.priority.slice(1)}`),r.partitioned){if(!r.secure)throw new Error("Partitioned Cookie must have Secure attributes");s+="; Partitioned"}return s},mt=(e,t,r)=>(t=encodeURIComponent(t),us(e,t,r)),dr=(e,t,r)=>{const s=e.req.raw.headers.get("Cookie");{if(!s)return;let n=t;return r==="secure"?n="__Secure-"+t:r==="host"&&(n="__Host-"+t),hs(s,n)[n]}},fs=(e,t,r)=>{let s;return(r==null?void 0:r.prefix)==="secure"?s=mt("__Secure-"+e,t,{path:"/",...r,secure:!0}):(r==null?void 0:r.prefix)==="host"?s=mt("__Host-"+e,t,{...r,path:"/",secure:!0,domain:void 0}):s=mt(e,t,{path:"/",...r}),s},pr=(e,t,r,s)=>{const n=fs(t,r,s);e.header("Set-Cookie",n,{append:!0})},gs=(e,t,r)=>{const s=dr(e,t,r==null?void 0:r.prefix);return pr(e,t,"",{...r,maxAge:0}),s};typeof process<"u"&&process.env&&(process.env.POSTGRES_URL=process.env.POSTGRES_URL||process.env.DATABASE_POSTGRES_URL||process.env.DATABASE_URL);function Ot(e){return J(e)}const se=new Ct;se.use("*",async(e,t)=>{const r=new URL(e.req.url).pathname;if(r==="/admin/login"||r.startsWith("/static/"))return t();const s=e.env.ADMIN_PASSWORD||process.env.ADMIN_PASSWORD||"paraKenya8#";return dr(e,"codeward_admin_session")===s?t():e.redirect("/admin/login")});se.get("/login",e=>{const t=`<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8"/>
...
</html>`;return e.html(t)});se.post("/login",async e=>{const t=await e.req.parseBody(),r=e.env.ADMIN_USERNAME||process.env.ADMIN_USERNAME||"kelvin.reallife8@gmail.com",s=e.env.ADMIN_PASSWORD||process.env.ADMIN_PASSWORD||"paraKenya8#";return t.username===r&&t.password===s?(pr(e,"codeward_admin_session",s,{path:"/admin",httpOnly:!0,secure:!0,maxAge:3600*24*7}),e.redirect("/admin")):e.redirect("/admin/login?error=1")});se.get("/logout",e=>(gs(e,"codeward_admin_session",{path:"/admin"}),e.redirect("/admin/login")));const st={"software-engineer":"Software Engineer","senior-engineer":"Senior / Staff Engineer","engineering-lead":"Engineering Lead / Manager","cto-vp":"CTO / VP of Engineering","devops-platform":"DevOps / Platform Engineer","security-engineer":"Security Engineer",freelancer:"Freelance Developer","open-source":"Open Source Contributor",student:"Student / Bootcamp",founder:"Founder / Indie Hacker",other:"Other"};function I(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function we(e){if(e==null)return"";const t=String(e);return/[",\n]/.test(t)?'"'+t.replace(/"/g,'""')+'"':t}se.get("/",async e=>{var Lt,Pt,_t,$t,jt,Dt;const{env:t}=e,r=new URL(e.req.url),s=(r.searchParams.get("q")||"").trim(),n=(r.searchParams.get("role")||"").trim(),a=Math.max(1,parseInt(r.searchParams.get("page")||"1",10)||1),i=25,l=r.searchParams.get("msg")||"";let p="";l==="retrigger_success"?p='<div style="background: rgba(16, 185, 129, 0.1); border: 1px solid rgba(16, 185, 129, 0.3); color: #10b981; padding: 12px 16px; border-radius: 8px; margin-bottom: 24px; font-weight: 500; display: flex; align-items: center; gap: 8px;"><svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"></path></svg> Email successfully resent!</div>':l==="retrigger_failed"&&(p='<div style="background: rgba(239, 68, 68, 0.1); border: 1px solid rgba(239, 68, 68, 0.3); color: #ef4444; padding: 12px 16px; border-radius: 8px; margin-bottom: 24px; font-weight: 500; display: flex; align-items: center; gap: 8px;"><svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12"></path></svg> Failed to resend email. Please check the logs.</div>');let o="WHERE 1=1";const c=[];let d=1;if(s){o+=` AND (LOWER(name) LIKE $${d++} OR LOWER(email) LIKE $${d++} OR LOWER(company) LIKE $${d++})`;const S=`%${s.toLowerCase()}%`;c.push(S,S,S)}n&&(o+=` AND role = $${d++}`,c.push(n));const u=await Ot(e).connect(),g=await u.query(`SELECT COUNT(*) as cnt FROM waitlist_entries ${o}`,c),f=Number(((Lt=g.rows[0])==null?void 0:Lt.cnt)??0),b=Math.max(1,Math.ceil(f/i)),v=Math.min(a,b),x=(v-1)*i,E=[...c,i,x],A=(await u.query(`SELECT id, name, email, role, company, github, position, created_at, email_sent, linkedin_clicked
     FROM waitlist_entries ${o}
     ORDER BY created_at DESC
     LIMIT $${d++} OFFSET $${d++}`,E)).rows||[],De=await u.query("SELECT COUNT(*) as cnt FROM waitlist_entries"),ve=Number(((Pt=De.rows[0])==null?void 0:Pt.cnt)??0),j=await u.query(`SELECT 
       SUM(CASE WHEN email_sent = 1 THEN 1 ELSE 0 END) as sent,
       SUM(CASE WHEN email_sent = 0 THEN 1 ELSE 0 END) as failed
     FROM waitlist_entries`),pt=Number(((_t=j.rows[0])==null?void 0:_t.sent)??0),Xe=Number((($t=j.rows[0])==null?void 0:$t.failed)??0),ae=await u.query("SELECT COUNT(*) as cnt FROM waitlist_entries WHERE created_at::DATE = CURRENT_DATE"),$=Number(((jt=ae.rows[0])==null?void 0:jt.cnt)??0),be=(await u.query("SELECT role, COUNT(*) as cnt FROM waitlist_entries GROUP BY role ORDER BY cnt DESC")).rows,Y=await u.query("SELECT COUNT(*) as cnt FROM waitlist_entries WHERE company IS NOT NULL AND company != ''"),ie=Number(((Dt=Y.rows[0])==null?void 0:Dt.cnt)??0),yr=Object.entries(st).map(([S,_])=>`<option value="${S}" ${n===S?"selected":""}>${I(_)}</option>`).join(""),wr=A.length?A.map(S=>{const _=new Date(S.created_at+"Z"),He=isNaN(_.getTime())?S.created_at:_.toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric"})+" · "+_.toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"});return`
        <tr>
          <td class="pos-cell">#${616+S.position}</td>
          <td>
            <div class="name-cell">${I(S.name)}</div>
            <div class="email-cell">${I(S.email)}</div>
          </td>
          <td><span class="role-badge">${I(st[S.role]||S.role)}</span></td>
          <td>${S.company?I(S.company):'<span class="muted">—</span>'}</td>
          <td>${S.github?`<a href="${I(S.github)}" target="_blank" rel="noopener" class="github-link">${I(S.github.replace(/^https?:\/\/(www\.)?github\.com\//,"@"))}</a>`:'<span class="muted">—</span>'}</td>
          ...
          <td>
            ${S.email_sent===1?'<span class="role-badge" style="background:#059669;color:#fff;">Sent</span>':`<div style="display:flex;gap:8px;align-items:center;">
                   ...
                   <form method="post" action="/admin/retrigger" style="margin:0;">
                     <input type="hidden" name="email" value="${I(S.email)}" />
        ...
        </tr>`}).join(""):'<tr><td colspan="7" class="empty-row">No waitlist entries match your filters.</td></tr>',xr=(be||[]).map(S=>{const _=Number(S.cnt),He=ve?Math.round(_/ve*100):0;return`
      <div class="role-bar-row">
        <div class="role-bar-label">${I(st[S.role]||S.role)}</div>
        <div class="role-bar-track"><div class="role-bar-fill" style="width:${He}%"></div></div>
        <div class="role-bar-count">${_}</div>
      </div>`}).join(""),ht=S=>{const _=new URLSearchParams;return s&&_.set("q",s),n&&_.set("role",n),_.set("page",String(v)),Object.entries(S).forEach(([He,Rr])=>_.set(He,String(Rr))),"?"+_.toString()},Er=`<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8"/>
<meta name="viewport" content="width=device-width, initial-scale=1.0"/>
  ...
  <section class="panel">
    ...
    <div class="pagination">
      ...
      <div class="page-buttons">
        <a href="/admin${ht({page:Math.max(1,v-1)})}" class="page-btn ${v<=1?"disabled":""}">&larr; Prev</a>
        <span class="page-current">Page ${v} of ${b}</span>
        <a href="/admin${ht({page:Math.min(b,v+1)})}" class="page-btn ${v>=b?"disabled":""}">Next &rarr;</a>
      </div>
    </div>
  </section>
...
</html>`;return e.html(Er)});se.get("/export.csv",async e=>{const{env:t}=e,r=new URL(e.req.url),s=(r.searchParams.get("q")||"").trim(),n=(r.searchParams.get("role")||"").trim();let a="WHERE 1=1";const i=[];let l=1;if(s){a+=` AND (LOWER(name) LIKE $${l++} OR LOWER(email) LIKE $${l++} OR LOWER(company) LIKE $${l++})`;const f=`%${s.toLowerCase()}%`;i.push(f,f,f)}n&&(a+=` AND role = $${l++}`,i.push(n));const c=(await(await Ot(e).connect()).query(`SELECT id, name, email, role, company, github, position, created_at
     FROM waitlist_entries ${a}
     ORDER BY created_at ASC`,i)).rows||[],u=[["Position","Name","Email","Role","Company","GitHub","Joined At (UTC)"].join(",")];for(const f of c)u.push([616+f.position,we(f.name),we(f.email),we(st[f.role]||f.role),we(f.company||""),we(f.github||""),we(f.created_at)].join(","));const g=u.join(`
`);return new Response(g,{headers:{"Content-Type":"text/csv; charset=utf-8","Content-Disposition":`attachment; filename="codeward-waitlist-${new Date().toISOString().slice(0,10)}.csv"`}})});se.post("/retrigger",async e=>{const{env:t}=e,s=((await e.req.parseBody()).email||"").toString().trim();if(!s)return e.redirect("/admin");const n=await Ot(e).connect(),i=(await n.query("SELECT name, position FROM waitlist_entries WHERE email = $1",[s])).rows[0];return i&&await hr(t,s,i.name,i.position)?(await n.query("UPDATE waitlist_entries SET email_sent = 1 WHERE email = $1",[s]),e.redirect("/admin?msg=retrigger_success")):e.redirect("/admin?msg=retrigger_failed")});typeof process<"u"&&process.env&&(process.env.POSTGRES_URL=process.env.POSTGRES_URL||process.env.DATABASE_POSTGRES_URL||process.env.DATABASE_URL);function ms(e){const s=`https://${new URL(e).hostname}/sql`;async function n(i,l=[]){const p=await fetch(s,{method:"POST",headers:{"Content-Type":"application/json","Neon-Connection-String":e},body:JSON.stringify({query:i,params:l})});if(!p.ok){const c=await p.text();throw new Error(`DB error ${p.status}: ${c}`)}const o=await p.json();return{rows:o.rows??[],rowCount:o.rowCount??0}}async function a(i,...l){let p="";const o=[];return i.forEach((c,d)=>{p+=c,d<l.length&&(o.push(l[d]===void 0?null:l[d]),p+=`$${o.length}`)}),n(p,o)}return a.connect=async()=>({query:n,release:()=>{}}),a.query=n,a}let vt=null;function J(e){var t,r,s;if(!vt){const n=((t=e==null?void 0:e.env)==null?void 0:t.POSTGRES_URL)||((r=e==null?void 0:e.env)==null?void 0:r.DATABASE_POSTGRES_URL)||((s=e==null?void 0:e.env)==null?void 0:s.DATABASE_URL)||(typeof process<"u"&&process.env?process.env.POSTGRES_URL||process.env.DATABASE_POSTGRES_URL||process.env.DATABASE_URL:void 0);if(!n)throw new Error("No database connection string found in environment");vt=ms(n)}return vt}function vs(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}const ne=new Ct;ne.onError((e,t)=>(console.error("Hono Global Error:",e),t.json({error:e.message||"Internal Server Error"},500)));ne.route("/admin",se);const Re=617;ne.get("/api/stats",async e=>{var n;const{env:t}=e,{rows:r}=await J(e)`SELECT COUNT(*) as cnt FROM waitlist_entries`,s=Number(((n=r[0])==null?void 0:n.cnt)??0);return e.json({count:Re+s})});function bs(e){function t(f,b){const v=(f&65535)+(b&65535);return(f>>16)+(b>>16)+(v>>16)<<16|v&65535}function r(f,b){return f<<b|f>>>32-b}function s(f,b,v,x,E,k){return t(r(t(t(b,f),t(x,k)),E),v)}function n(f,b,v,x,E,k,A){return s(b&v|~b&x,f,b,E,k,A)}function a(f,b,v,x,E,k,A){return s(b&x|v&~x,f,b,E,k,A)}function i(f,b,v,x,E,k,A){return s(b^v^x,f,b,E,k,A)}function l(f,b,v,x,E,k,A){return s(v^(b|~x),f,b,E,k,A)}function p(f){const b=(f.length+8>>6)+1,v=new Array(b*16).fill(0);for(let x=0;x<f.length;x++)v[x>>2]|=f.charCodeAt(x)<<x%4*8;return v[f.length>>2]|=128<<f.length%4*8,v[b*16-2]=f.length*8,v}const o=p(e.toLowerCase().trim());let c=1732584193,d=-271733879,u=-1732584194,g=271733878;for(let f=0;f<o.length;f+=16){const[b,v,x,E]=[c,d,u,g];c=n(c,d,u,g,o[f+0],7,-680876936),d=n(g,c,d,u,o[f+1],12,-389564586),u=n(u,g,c,d,o[f+2],17,606105819),g=n(d,u,g,c,o[f+3],22,-1044525330),c=n(c,d,u,g,o[f+4],7,-176418897),d=n(g,c,d,u,o[f+5],12,1200080426),u=n(u,g,c,d,o[f+6],17,-1473231341),g=n(d,u,g,c,o[f+7],22,-45705983),c=n(c,d,u,g,o[f+8],7,1770035416),d=n(g,c,d,u,o[f+9],12,-1958414417),u=n(u,g,c,d,o[f+10],17,-42063),g=n(d,u,g,c,o[f+11],22,-1990404162),c=n(c,d,u,g,o[f+12],7,1804603682),d=n(g,c,d,u,o[f+13],12,-40341101),u=n(u,g,c,d,o[f+14],17,-1502002290),g=n(d,u,g,c,o[f+15],22,1236535329),c=a(c,d,u,g,o[f+1],5,-165796510),d=a(g,c,d,u,o[f+6],9,-1069501632),u=a(u,g,c,d,o[f+11],14,643717713),g=a(d,u,g,c,o[f+0],20,-373897302),c=a(c,d,u,g,o[f+5],5,-701558691),d=a(g,c,d,u,o[f+10],9,38016083),u=a(u,g,c,d,o[f+15],14,-660478335),g=a(d,u,g,c,o[f+4],20,-405537848),c=a(c,d,u,g,o[f+9],5,568446438),d=a(g,c,d,u,o[f+14],9,-1019803690),u=a(u,g,c,d,o[f+3],14,-187363961),g=a(d,u,g,c,o[f+8],20,1163531501),c=a(c,d,u,g,o[f+13],5,-1444681467),d=a(g,c,d,u,o[f+2],9,-51403784),u=a(u,g,c,d,o[f+7],14,1735328473),g=a(d,u,g,c,o[f+12],20,-1926607734),c=i(c,d,u,g,o[f+5],4,-378558),d=i(g,c,d,u,o[f+8],11,-2022574463),u=i(u,g,c,d,o[f+11],16,1839030562),g=i(d,u,g,c,o[f+14],23,-35309556),c=i(c,d,u,g,o[f+1],4,-1530992060),d=i(g,c,d,u,o[f+4],11,1272893353),u=i(u,g,c,d,o[f+7],16,-155497632),g=i(d,u,g,c,o[f+10],23,-1094730640),c=i(c,d,u,g,o[f+13],4,681279174),d=i(g,c,d,u,o[f+0],11,-358537222),u=i(u,g,c,d,o[f+3],16,-722521979),g=i(d,u,g,c,o[f+6],23,76029189),c=i(c,d,u,g,o[f+9],4,-640364487),d=i(g,c,d,u,o[f+12],11,-421815835),u=i(u,g,c,d,o[f+15],16,530742520),g=i(d,u,g,c,o[f+2],23,-995338651),c=l(c,d,u,g,o[f+0],6,-198630844),d=l(g,c,d,u,o[f+7],10,1126891415),u=l(u,g,c,d,o[f+14],15,-1416354905),g=l(d,u,g,c,o[f+5],21,-57434055),c=l(c,d,u,g,o[f+12],6,1700485571),d=l(g,c,d,u,o[f+3],10,-1894986606),u=l(u,g,c,d,o[f+10],15,-1051523),g=l(d,u,g,c,o[f+1],21,-2054922799),c=l(c,d,u,g,o[f+8],6,1873313359),d=l(g,c,d,u,o[f+15],10,-30611744),u=l(u,g,c,d,o[f+6],15,-1560198380),g=l(d,u,g,c,o[f+13],21,1309151649),c=l(c,d,u,g,o[f+4],6,-145523070),d=l(g,c,d,u,o[f+11],10,-1120210379),u=l(u,g,c,d,o[f+2],15,718787259),g=l(d,u,g,c,o[f+9],21,-343485551),c=t(c,b),d=t(d,v),u=t(u,x),g=t(g,E)}return[c,d,u,g].map(f=>{let b="";for(let v=0;v<4;v++)b+=("0"+(f>>v*8&255).toString(16)).slice(-2);return b}).join("")}ne.get("/api/avatars",async e=>{try{const{rows:t}=await J(e)`SELECT name, email FROM waitlist_entries ORDER BY id DESC LIMIT 8`,r=t.map(s=>{let n="";try{n=bs(s.email||"")}catch{}const a=(s.name||"").trim(),i=a.split(" ")[0]||"",l=a.split(" ")[1]||"";return{initials:((i[0]||"")+(l[0]||"")).toUpperCase()||"?",emailHash:n}});return e.json({avatars:r},200,{"Cache-Control":"public, max-age=60"})}catch{return e.json({avatars:[]})}});ne.post("/api/join",async e=>{const{env:t}=e;let r;try{r=await e.req.json()}catch{return e.json({error:"Invalid request body"},400)}const s=(r.name||"").toString().trim(),n=(r.email||"").toString().trim().toLowerCase(),a=(r.role||"").toString().trim(),i=(r.company||"").toString().trim(),l=(r.github||"").toString().trim();if(s.length<2)return e.json({error:"Please enter your full name."},400);if(!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(n))return e.json({error:"Please enter a valid email address."},400);if(!a)return e.json({error:"Please select your role."},400);const{rows:p}=await J(e)`SELECT id, position FROM waitlist_entries WHERE email = ${n}`,o=p[0];if(o){const{rows:b}=await J(e)`SELECT COUNT(*) as cnt FROM waitlist_entries`,v=b[0];return e.json({alreadyJoined:!0,position:Re+Number(o.position),total:Re+Number((v==null?void 0:v.cnt)??0)})}const{rows:c}=await J(e)`SELECT COUNT(*) as cnt FROM waitlist_entries`,d=c[0],u=Number((d==null?void 0:d.cnt)??0)+1;await J(e)`INSERT INTO waitlist_entries (name, email, role, company, github, position) VALUES (${s}, ${n}, ${a}, ${i||null}, ${l||null}, ${u})`;let g=0;return process.env.RESEND_API_KEY&&await hr(t,n,s,u)&&(g=1),await J(e)`UPDATE waitlist_entries SET email_sent = ${g} WHERE email = ${n}`,e.json({success:!0,position:Re+u,total:Re+Number((d==null?void 0:d.cnt)??0)+1})});async function hr(e,t,r,s){const n=e.RESEND_API_KEY||process.env.RESEND_API_KEY;if(!n)return!1;try{const a=(Re+s).toLocaleString(),i=`<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8" />
...
</html>`;var ce=class extends Error{constructor(e,t){super(e,t),this.name="RequestError"}},ws=e=>e instanceof ce?e:new ce(e.message,{cause:e}),xs=global.Request,ze=class extends xs{constructor(t,r){var s;typeof t=="object"&&$e in t&&(t=t[$e]()),typeof((s=r==null?void 0:r.body)==null?void 0:s.getReader)<"u"&&(r.duplex??(r.duplex="half")),super(t,r)}},Es=e=>{const t=[],r=e.rawHeaders;for(let s=0;s<r.length;s+=2){const{[s]:n,[s+1]:a}=r;n.charCodeAt(0)!==58&&t.push([n,a])}return new Headers(t)},ur=Symbol("wrapBodyStream"),Rs=(e,t,r,s,n)=>{const a={method:e,headers:r,signal:n.signal};if(e==="TRACE"){a.method="GET";const i=new ze(t,a);return Object.defineProperty(i,"method",{get(){return"TRACE"}}),i}if(!(e==="GET"||e==="HEAD"))if("rawBody"in s&&s.rawBody instanceof Buffer)a.body=new ReadableStream({start(i){i.enqueue(s.rawBody),i.close()}});else if(s[ur]){let i;a.body=new ReadableStream({async pull(l){try{i||(i=Mt.toWeb(s).getReader());const{done:p,value:o}=await i.read();p?l.close():l.enqueue(o)}catch(p){l.error(p)}}})}else a.body=Mt.toWeb(s);return new ze(t,a)},$e=Symbol("getRequestCache"),nt=Symbol("requestCache"),at=Symbol("incomingKey"),ot=Symbol("urlKey"),bt=Symbol("headersKey"),Q=Symbol("abortControllerKey"),Ss=Symbol("getAbortController"),Qe={get method(){return this[at].method||"GET"},get url(){return this[ot]},get headers(){return this[bt]||(this[bt]=Es(this[at]))},[Ss](){return this[$e](),this[Q]},[$e](){return this[Q]||(this[Q]=new AbortController),this[nt]||(this[nt]=Rs(this.method,this[ot],this.headers,this[at],this[Q]))}};["body","bodyUsed","cache","credentials","destination","integrity","mode","redirect","referrer","referrerPolicy","signal","keepalive"].forEach(e=>{Object.defineProperty(Qe,e,{get(){return this[$e]()[e]}})});["arrayBuffer","blob","clone","formData","json","text"].forEach(e=>{Object.defineProperty(Qe,e,{value:function(){return this[$e]()[e]()}})});Object.defineProperty(Qe,Symbol.for("nodejs.util.inspect.custom"),{value:function(e,t,r){const s={method:this.method,url:this.url,headers:this.headers,nativeRequest:this[nt]};return`Request (lightweight) ${r(s,{...t,depth:e==null?null:e-1})}`}});Object.setPrototypeOf(Qe,ze.prototype);var ks=(e,t)=>{const r=Object.create(Qe);r[at]=e;const s=e.url||"";if(s[0]!=="/"&&(s.startsWith("http://")||s.startsWith("https://"))){if(e instanceof Ue)throw new ce("Absolute URL for :path is not allowed in HTTP/2");try{const l=new URL(s);r[ot]=l.href}catch(l){throw new ce("Invalid absolute URL",{cause:l})}return r}const n=(e instanceof Ue?e.authority:e.headers.host)||t;if(!n)throw new ce("Missing host header");let a;if(e instanceof Ue){if(a=e.scheme,!(a==="http"||a==="https"))throw new ce("Unsupported scheme")}else a=e.socket&&e.socket.encrypted?"https":"http";const i=new URL(`${a}://${n}${s}`);if(i.hostname.length!==n.length&&i.hostname!==n.replace(/:\d+$/,""))throw new ce("Invalid host header");return r[ot]=i.href,r},Ie=Symbol("responseCache"),Se=Symbol("getResponseCache"),de=Symbol("cache"),At=global.Response,Je,W,_e,je=(_e=class{constructor(t,r){w(this,Je);w(this,W);let s;if(m(this,Je,t),r instanceof _e){const n=r[Ie];if(n){m(this,W,n),this[Se]();return}else m(this,W,h(r,W)),s=new Headers(h(r,W).headers)}else m(this,W,r);(typeof t=="string"||typeof(t==null?void 0:t.getReader)<"u"||t instanceof Blob||t instanceof Uint8Array)&&(this[de]=[(r==null?void 0:r.status)||200,t,s||(r==null?void 0:r.headers)])}[Se](){return delete this[de],this[Ie]||(this[Ie]=new At(h(this,Je),h(this,W)))}get headers(){const t=this[de];return t?(t[2]instanceof Headers||(t[2]=new Headers(t[2]||{"content-type":"text/plain; charset=UTF-8"})),t[2]):this[Se]().headers}get status(){var t;return((t=this[de])==null?void 0:t[0])??this[Se]().status}get ok(){const t=this.status;return t>=200&&t<300}},Je=new WeakMap,W=new WeakMap,_e);["body","bodyUsed","redirected","statusText","trailers","type","url"].forEach(e=>{Object.defineProperty(je.prototype,e,{get(){return this[Se]()[e]}})});["arrayBuffer","blob","clone","formData","json","text"].forEach(e=>{Object.defineProperty(je.prototype,e,{value:function(){return this[Se]()[e]()}})});Object.defineProperty(je.prototype,Symbol.for("nodejs.util.inspect.custom"),{value:function(e,t,r){const s={status:this.status,headers:this.headers,ok:this.ok,nativeResponse:this[Ie]};return`Response (lightweight) ${r(s,{...t,depth:e==null?null:e-1})}`}});Object.setPrototypeOf(je,At);Object.setPrototypeOf(je.prototype,At.prototype);async function Cs(e){return Promise.race([e,Promise.resolve().then(()=>Promise.resolve(void 0))])}function fr(e,t,r){const s=l=>{e.cancel(l).catch(()=>{})};return t.on("close",s),t.on("error",s),(r??e.read()).then(i,n),e.closed.finally(()=>{t.off("close",s),t.off("error",s)});function n(l){l&&t.destroy(l)}function a(){e.read().then(i,n)}function i({done:l,value:p}){try{if(l)t.end();else if(!t.write(p))t.once("drain",a);else return e.read().then(i,n)}catch(o){n(o)}}}function Os(e,t){if(e.locked)throw new TypeError("ReadableStream is locked.");return t.destroyed?void 0:fr(e.getReader(),t)}var Et=e=>{const t={};e instanceof Headers||(e=new Headers(e??void 0));const r=[];for(const[s,n]of e)s==="set-cookie"?r.push(n):t[s]=n;return r.length>0&&(t["set-cookie"]=r),t["content-type"]??(t["content-type"]="text/plain; charset=UTF-8"),t},As="x-hono-already-sent";typeof global.crypto>"u"&&(global.crypto=Or);var Tt=Symbol("outgoingEnded"),zt=Symbol("incomingDraining"),Ts=500,Ls=64*1024*1024,yt=e=>{var l,p,o;const t=e;if(e.destroyed||t[zt])return;if(t[zt]=!0,e instanceof Ue){try{(p=(l=e.stream)==null?void 0:l.close)==null||p.call(l,Cr.NGHTTP2_NO_ERROR)}catch{}return}let r=0;const s=()=>{clearTimeout(a),e.off("data",i),e.off("end",s),e.off("error",s)},n=()=>{s();const c=e.socket;c&&!c.destroyed&&c.destroySoon()},a=setTimeout(n,Ts);(o=a.unref)==null||o.call(a);const i=c=>{r+=c.length,r>Ls&&n()};e.on("data",i),e.on("end",s),e.on("error",s),e.resume()},Ps=()=>new Response(null,{status:400}),gr=e=>new Response(null,{status:e instanceof Error&&(e.name==="TimeoutError"||e.constructor.name==="TimeoutError")?504:500}),Rt=(e,t)=>{const r=e instanceof Error?e:new Error("unknown error",{cause:e});r.code==="ERR_STREAM_PREMATURE_CLOSE"?console.info("The user aborted a request."):(console.error(e),t.headersSent||t.writeHead(500,{"Content-Type":"text/plain"}),t.end(`Error: ${r.message}`),t.destroy(r))},mr=e=>{"flushHeaders"in e&&e.writable&&e.flushHeaders()},vr=async(e,t)=>{var i,l;let[r,s,n]=e[de],a=!1;if(!n)n={"content-type":"text/plain; charset=UTF-8"};else if(n instanceof Headers)a=n.has("content-length"),n=Et(n);else if(Array.isArray(n)){const p=new Headers(n);a=p.has("content-length"),n=Et(p)}else for(const p in n)if(p.length===14&&p.toLowerCase()==="content-length"){a=!0;break}a||(typeof s=="string"?n["Content-Length"]=Buffer.byteLength(s):s instanceof Uint8Array?n["Content-Length"]=s.byteLength:s instanceof Blob&&(n["Content-Length"]=s.size)),t.writeHead(r,n),typeof s=="string"||s instanceof Uint8Array?t.end(s):s instanceof Blob?t.end(new Uint8Array(await s.arrayBuffer())):(mr(t),await((i=Os(s,t))==null?void 0:i.catch(p=>Rt(p,t)))),(l=t[Tt])==null||l.call(t)},_s=e=>typeof e.then=="function",$s=async(e,t,r={})=>{var n;if(_s(e))if(r.errorHandler)try{e=await e}catch(a){const i=await r.errorHandler(a);if(!i)return;e=i}else e=await e.catch(gr);if(de in e)return vr(e,t);const s=Et(e.headers);if(e.body){const a=e.body.getReader(),i=[];let l=!1,p;if(s["transfer-encoding"]!=="chunked"){let o=2;for(let c=0;c<o;c++){p||(p=a.read());const d=await Cs(p).catch(u=>{console.error(u),l=!0});if(!d){if(c===1){await new Promise(u=>setTimeout(u)),o=3;continue}break}if(p=void 0,d.value&&i.push(d.value),d.done){l=!0;break}}l&&!("content-length"in s)&&(s["content-length"]=i.reduce((c,d)=>c+d.length,0))}t.writeHead(e.status,s),i.forEach(o=>{t.write(o)}),l?t.end():(i.length===0&&mr(t),await fr(a,t,p))}else s[As]||(t.writeHead(e.status,s),t.end());(n=t[Tt])==null||n.call(t)},js=(e,t={})=>{const r=t.autoCleanupIncoming??!0;return t.overrideGlobalObjects!==!1&&global.Request!==ze&&(Object.defineProperty(global,"Request",{value:ze}),Object.defineProperty(global,"Response",{value:je})),async(s,n)=>{let a,i;try{i=ks(s,t.hostname);let l=!r||s.method==="GET"||s.method==="HEAD";if(l||(s[ur]=!0,s.on("end",()=>{l=!0}),s instanceof Ue&&(n[Tt]=()=>{l||setTimeout(()=>{l||setTimeout(()=>{yt(s)})})}),n.on("finish",()=>{l||yt(s)})),n.on("close",()=>{i[Q]&&(s.errored?i[Q].abort(s.errored.toString()):n.writableFinished||i[Q].abort("Client connection prematurely closed.")),l||setTimeout(()=>{l||setTimeout(()=>{yt(s)})})}),a=e(i,{incoming:s,outgoing:n}),de in a)return vr(a,n)}catch(l){if(a)return Rt(l,n);if(t.errorHandler){if(a=await t.errorHandler(i?l:ws(l)),!a)return}else i?a=gr(l):a=Ps()}try{return await $s(a,n,t)}catch(l){return Rt(l,n)}}},Ds=e=>js(e.fetch);const St=new Ct,Hs=Object.assign({"/src/index.tsx":ne});let br=!1;for(const[,e]of Object.entries(Hs))e&&(St.all("*",t=>{let r;try{r=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,r)}),St.notFound(t=>{let r;try{r=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,r)}),br=!0);if(!br)throw new Error("Can't import modules from ['/src/index.ts','/src/index.tsx','/app/server.ts']");const Fs=Ds(St);export{Fs as default};
